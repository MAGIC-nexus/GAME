...
if(esito==true){
	...
	String region2 = region.replaceAll("region","");
	region2=region2.trim();
	op.newProoms(id,Integer.parseInt(IdS),region2,Idpr);
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-3M6Y3CD5K0"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-3M6Y3CD5K0');
</script>
...
.button-minus-days, .button-plus-days {
...
.green {
    text-shadow: 2px 2px 20px rgb(32, 173, 69), 1px 1px 2px rgba(32,173,69,1), 1px 1px 2px rgba(32,173,69,1);
}
</style>
...
<body onLoad="myHeight();" class="horizontal-layout horizontal-menu navbar-sticky 2-columns   footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
				      ...
				      <li class="nav-item d-none d-lg-block" style="padding-top:13px;"><a class="nav-link bookmark-star"  id="">
                           <i class="ficon bx bx-reset warning" id="reseticon" onclick="ResetGame()"></a></i></a>
                            </li>
				                   <li class="nav-item d-none d-lg-block" style="padding-top:13px;"><a title="Load a saved region configuration, selected by Region button"  class="nav-link bookmark-star"><i class="ficon bx bx-undo warning" id="loadicon" onclick="LoadGame()"></i></a></li>

				               <li class="nav-item d-none d-lg-block" style="padding-top:13px;"><a class="nav-link bookmark-star" id="position-top-start" title="Save a region configuration, selected by Region button"><i class="ficon bx bx-save warning" id="saveicon" onclick="SaveGame()"></i></a>
                            <li class="dropdown dropdown-notification nav-item d-none d-lg-block"></li>
                        <!-- <li id="eutargets" class="nav-item d-none d-lg-block" style="padding-top:1.7em; margin-left:20px; font-size:1rem;color:#FFFFFF;" >EU TARGETS</li> -->
							
							<li id="eutargets" class="nav-item d-none d-lg-block" style="padding-top:1.7em; margin-left:20px; font-size:1rem;color:#FFFFFF;" ></li>

                             <li id="foodup" class="nav-item d-none d-lg-block" style="margin-left:30px;padding-top:15px;text-align:left; visibility: hidden">

                             <a data-toggle="tooltip" data-placement="bottom"
                             title="% of food supply met by agricolture in the EU" id="">
                             <img src="icon/fs.png" style="width:24px;" >
                             </a>
                             </li>

                             <li id="euf" class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:15px; visibility: hidden">
                             <a data-toggle="tooltip" data-placement="bottom"  style="font-size:1.2rem;color:#E55B3C;"
                             title="Target value &ge;95% " id="">
                             <span id="eufood"></span>
                             </a>
                             </li>

                              <li id="euet" class="nav-item d-none d-lg-block" style="margin-left:15px;padding-top:15px; visibility: hidden">
                              <a data-toggle="tooltip" data-placement="bottom" title="% of energy supply met by energy in the EU" id="">
                              <img src="icon/es.png" style="width:24px;"  >
                              </a>
                              </li>

                             <li id="securitysup" class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:15px;visibility: hidden">
                             <a data-toggle="tooltip" data-placement="bottom" style="font-size:1.2rem;color:#E55B3C;"
                             title="Target value &ge;70% " id="">
                             <span id="euenergy"></span>
                             </a>
                             </li>

                              <li class="nav-item d-none d-lg-block" style="margin-left:15px;padding-top:15px; visibility: hidden">
                              <a data-toggle="tooltip" data-placement="bottom"
                              title="EU-average carbon footprint of production" id="">
                             <img src="icon/cb.png" style="width:24px;">
                              </a>
                              </li>

                             <li class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:20px; padding-bottom:10px; visibility: hidden">
                             <a data-toggle="tooltip" data-placement="bottom"
                             title="Target value &le;16" id="" style="font-size:1.2rem;color:#E55B3C;">
                             <span id="carboneu"></span>
                             </a>

                             </li>

                           <li id="counterss" class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:20px;"><span id="counter_not"></span><span> request(s)</</span></li>

							<li class="dropdown dropdown-notification nav-item d-none d-lg-block" >

						 <a class="nav-link nav-link-label" href="#" data-toggle="dropdown" onClick="MyTradeMulti('<%=region %>','<%=code %>','<%=stanza%>');"><i class="ficon bx bx-bell bx-tada bx-flip-horizontal"></i></a>
						...
						<!--	 <li class="dropdown dropdown-notification nav-item d-none d-lg-block">
						  <a data-toggle="tooltip" data-placement="bottom" title="Notification Center" id=""> </li> -->
                  <li class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:25px;font-size:1rem;color:#FFFFFF;font-style:italic;" id="loadimport">   </li>
                       <li class="nav-item d-none d-lg-block" style="padding-top:20px;font-size:0.4rem;color:#FFFFFF;font-style:italic;" id=""><div id="WT" style="font-size:1rem;"></div> </li>
                    ...
                    <div id="user-status"><span style="color:#fff"></span></div>
                              ...
                              <a data-toggle="tooltip" data-placement="bottom" title="LAND Exceedance of sustainable limits" id="">
                             ...
                             <a data-toggle="tooltip" data-placement="bottom" title="Target value &le;0" id="land_tooltip" style="font-size:1.2rem;color:#E55B3C;">
                              <span id="Land_limits"></span></a>
                             </li>

                               <li class="nav-item d-none d-lg-block" style="padding-top:8px;text-align:right;padding-right:5px;">
                               <a data-toggle="tooltip" data-placement="bottom" title="GREEN WATER Exceedance sustainable limits" id="">
                               <img src="icon/gww.png" style="width:24px;">
                               </a>
                               </li>
                             <li class="nav-item d-none d-lg-block" style="text-align:right;padding-right:15px;padding-top:8px;">

                             <a data-toggle="tooltip" data-placement="bottom" title="Target value &le;0" id="green_tooltip" style="font-size:1.2rem;color:#E55B3C;">
                              <span id="GW_limits"></span></a>

                             </li>

                               <li class="nav-item d-none d-lg-block" style="padding-top:8px;text-align:right;padding-right:5px;">
                                <a data-toggle="tooltip" data-placement="bottom" title="BLUE WATER Exceedance of sustainable limits" id="">
                             ...
                             <a data-toggle="tooltip" data-placement="bottom" title="Target value &le;0" id="blue_tooltip" style="font-size:1.2rem;color:#B1FB17;">
                                    ...
                                    <!-- accordion start -->
                                     ...
                                     Play now: make your choices! 
                                        <div class="modal-primary mr-1 mb-1 d-inline-block" style="text-align:right;float:right;">
                                                ...
                                                <h6 class="media-heading"><span class="text-bold-500" id="current_dash">Current Dashboard</span></h6><small class="notification-text" style="color:red;font-weight:500;" ></small>
    <div class="modal-body" style="font-weight:normal;color:black;" id="tabscore">
   <h3>TOTAL SCORE: </h3><br><h3 id="total_score"></h3>
                    ...
                    <tr>
                        ...
                        <td id="cur_blue_D"> </td>
                                          ...
                                          <div style="width:100%;">
                                                    ...
                                                    <label for="lastNameRegion"><i class="livicon-evo" data-options="name:globe.svg; size: 35px; style:original; strokeColor: #22A7F0; "></i> <b>Chosen Region</b>: </label>
                                                    ...
                                                    <label id="labregionA" class="btn btn-a regionA nonattivo" style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;float:left;">
                                                        <input type="radio" class="form-control" name="region" id="regionA" style="padding:0.1rem 0.7rem;line-height: 2.5rem;height:auto;" onchange=" localSaveData(); localLoadData(); disableButtons('A'); MyTradeMulti('A','<%=code %>','<%=stanza%>');" checked> A
                                                    </label>
                                                    <label id="labregionB" class="btn btn-b regionB nonattivo " style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;margin-left:1%;float:left; ">
                                                        <input type="radio" class="form-control" name="region" id="regionB" style="padding:0.1rem 0.7rem;line-height: 2.5rem;height:auto;" onchange=" localSaveData(); localLoadData(); disableButtons('B'); MyTradeMulti('B','<%=code %>','<%=stanza%>');" >B
                                                    </label>
                                                    <label id="labregionC" class="btn btn-c regionC nonattivo" style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;margin-left:1%;float:left; ">
                                                        <input type="radio" class="form-control" name="region" id="regionC" style="padding:0.1rem 0.7rem;line-height: 2.5rem;height:auto;" onchange="  localSaveData(); localLoadData(); disableButtons('C'); MyTradeMulti('C','<%=code %>','<%=stanza%>');">C
                                                    </label>
                                                    <label id="labregionD" class="btn btn-d regionD nonattivo"  style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;margin-left:1%;float:left;">
                                                        <input type="radio" class="form-control" name="region" id="regionD" style="padding:0.1rem 0.7rem;line-height: 2.5rem;height:auto;" onchange="  localSaveData(); localLoadData(); disableButtons('D'); MyTradeMulti('D','<%=code %>','<%=stanza%>');">D
                                                    </label>
													...
													<b  id="MyEu" class="form-control btn btn-eu" style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;margin-left:1%;float:left;text-align:center;background-color:#FFCC00;color:white;height:auto;"><a id="MyEua" target="popup" href="#" onclick="window.open('EU-Index.html','popup','width=800,height=600,scrollbars=no,resizable=no'); return false;">EU</a></b>
                                                </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"  class="form-control color" name="D4" id="f_D4" placeholder="Food intake (kcal/cap/day)" value="2790" oninput="NOTNEG('f_D4')";>
                                                </div>
                                                ...
                                                <div class="boxy">
                                                  <div class="form-group" style="width:90%;margin-left:4%;">
                                                    <label for="emailAddress12">Vegan</label>
                                                      ...
                                                      <input type="text"  class="controllo touchspin form-control balancer color" name="C6" id="f_C6" data-bts-postfix="%" value="0" onfocus = "sessionStorage.setItem('f_C6', this.value)" onblur="Controllo('f_C6')" >
                                                  ...
                                                  <div class="form-group" style="width:90%;margin-left:4%;">
                                                    <label for="emailAddress12">Vegetarian</label>
                                                      ...
                                                      <input type="text"  class="controllo touchspin form-control balancer color" name="C7" id="f_C7" data-bts-postfix="%" value="6" onfocus = "sessionStorage.setItem('f_C7', this.value)" onblur="Controllo('f_C7')" >
                                                   ...
                                                   <div class="form-group" style="width:90%;margin-left:4%;">
                                                    <label for="emailAddress12">Flexitarian</label>
                                                      ...
                                                      <input type="text"  class="controllo touchspin form-control balancer color" name="C8" id="f_C8" value="94" data-bts-postfix="%" onfocus = "sessionStorage.setItem('f_C8', this.value)" onblur="Controllo('f_C8')" >


                                                </div>

                                                <div class="form-group input-group"  style="width:90%;margin-left:4%;">
                                                    <label for="A8">Nr of meat/fish days per week in the average flexitarian diet </label>
                                                  <input type="button" id="minusDays" value="-" class="button-minus-days" data-field="A8">
                                                    <input type="number" class="form-control quantity-field color" name="A8" id="A8_f" placeholder="7" value="7" min="1" max="7" oninput="";>
                                                  <input type="button" id="plusDays" value="+" class="button-plus-days" data-field="A8">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="card">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <input type="text" class="touchspin form-control balancer color" data-bts-postfix="%" name="D5" id="f_D5"  value="20" >
                                                </div>
                                    ...
                                    <div class="card-body pl-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" value="10" id="G14" name="G14" data-bts-postfix="%">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>% of rainfed land</label>
                                                   <input type="text"  class="touchspin form-control color" value="10"  id="G15" name="G15" data-bts-postfix="%">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" value="0"  name="G19" id="G19" data-bts-postfix="%">
                                                </div>
                                                <div class="form-group">
                                       ...
                                       <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" value="0" id="E30" name="E30" value="100" data-bts-postfix="%" onchange="Quest('plant based',this.value,document.getElementById('pb').innerHTML,'<%=code%>','<%=version%>','<%=stanza%>');">

                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group" id="plant-import-keyboard">
                                                    ...
                                                    <label class="btn btn-a" id="labelPlantA" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsplant" id="planta" value="A" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('A','pb');Quest('plant based',document.getElementById('E30').value,'A','<%=code%>','<%=version%>','<%=stanza%>');"> A
                                                    </label>
                                                    <label class="btn btn-b" id="labelPlantB" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsplant" id="plantb" value="B" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('B','pb');Quest('plant based',document.getElementById('E30').value,'B','<%=code%>','<%=version%>','<%=stanza%>');"> B
                                                    </label>
                                                    <label class="btn btn-c" id="labelPlantC" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsplant" id="plantc" value="C" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('C','pb');Quest('plant based',document.getElementById('E30').value,'C','<%=code%>','<%=version%>','<%=stanza%>');"> C
                                                    </label>
                                                    <label class="btn btn-d" id="labelPlantD" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonsplant" id="plantd" value="D" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('D','pb');Quest('plant based',document.getElementById('E30').value,'D','<%=code%>','<%=version%>','<%=stanza%>');"> D
                                                    </label>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" value="0"  id="E31" name="E31" value="100" data-bts-postfix="%" onchange="Quest('meat and fish',this.value,document.getElementById('mf').innerHTML,'<%=code%>','<%=version%>','<%=stanza%>');">

                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group" id="meat-import-keyboard">
                                                     <label for="lastName1">Source </label>
                                                     <div class="btn-group btn-group-toggle mb-1" data-toggle="buttons" style="position: relative;display: flex;flex-wrap: wrap;align-items: stretch;width: 100%;">
                                                     <label class="btn btn-a " id="labelMeatA" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsmeat" id="meata" value="A" onchange="Source('A','mf');Quest('meat and fish',document.getElementById('E31').value,'A','<%=code%>','<%=version%>','<%=stanza%>');" > A
                                                    </label>
                                                    <label class="btn btn-b " id="labelMeatB" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsmeat" id="meatb" value="B" onchange="Source('B','mf');Quest('meat and fish',document.getElementById('E31').value,'B','<%=code%>','<%=version%>','<%=stanza%>');" > B
                                                    </label>
                                                    <label class="btn btn-c" id="labelMeatC" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsmeat" id="meatc" value="C" onchange="Source('C','mf');Quest('meat and fish',document.getElementById('E31').value,'C','<%=code%>','<%=version%>','<%=stanza%>');" > C
                                                    </label>
                                                    <label class="btn btn-d" id="labelMeatD" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonsmeat" id="meatd" value="D" onchange="Source('D','mf');Quest('meat and fish',document.getElementById('E31').value,'D','<%=code%>','<%=version%>','<%=stanza%>');" > D
                                                    </label>
                                                    <label class="btn btn-w active" id="labelMeatW" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonsmeat" id="meatworld" value="W" checked onchange="Source('WORLD','mf');Clean('meat and fish','<%=version %>');"> WORLD
                                                    </label>
                                                </div>
                                                </div>
                                            </div>
                                          ...
                                          <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" value="0"  id="E32" name="E32" value="100" data-bts-postfix="%" onchange="Quest('diary and eggs',this.value,document.getElementById('de').innerHTML,'<%=code%>','<%=version%>','<%=stanza%>');">

                                                </div>
                                            </div>
                                             <div class="col-sm-6">
                                                <div class="form-group" id="diary-import-keyboard">
                                                     <label for="lastName1">Source </label>
                                                     <div class="btn-group btn-group-toggle mb-1" data-toggle="buttons" style="position: relative;display: flex;flex-wrap: wrap;align-items: stretch;width: 100%;">
                                                    <label class="btn btn-a " id="labelDiaryA" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsdiary" id="diarya" value="A" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('A','de');Quest('diary and eggs',document.getElementById('E32').value,'A','<%=code%>','<%=version%>','<%=stanza%>');"> A
                                                    </label>
                                                    <label class="btn btn-b " id="labelDiaryB" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsdiary" id="diaryb" value="B" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('B','de');Quest('diary and eggs',document.getElementById('E32').value,'B','<%=code%>','<%=version%>','<%=stanza%>');"> B
                                                    </label>
                                                    <label class="btn btn-c" id="labelDiaryC" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsdiary" id="diaryc" value="C" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('C','de');Quest('diary and eggs',document.getElementById('E32').value,'C','<%=code%>','<%=version%>','<%=stanza%>');"> C
                                                    </label>
                                                    <label class="btn btn-d" id="labelDiaryD" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonsdiary" id="diaryd" value="D" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('D','de');Quest('diary and eggs',document.getElementById('E32').value,'D','<%=code%>','<%=version%>','<%=stanza%>');"> D
                                                    </label>
                                                    <label class="btn btn-w active" id="labelDiaryW" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonsdiary" id="diaryworld" value="W" onchange="Source('WORLD','de');Clean('diary and eggs','<%=version %>');" checked style="padding:0.1rem 0.7rem;line-height: 2.5rem;"> WORLD
                                                    </label>
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  class="touchspin form-control color" data-bts-postfix="%" name="e_N5" id="e_N5" placeholder="Reduction in industry" value="0">
                                                </div>
                                            </div>
											  ...
											  <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  class="touchspin form-control color" data-bts-postfix="%"  name="e_N8" id="e_N8" placeholder="Reduction in households" value="0">
                                                </div>
                                            </div>
                                         ...
                                         <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  class="touchspin form-control color" data-bts-postfix="%"  name="e_N7" id="e_N7" placeholder="Reduction in the service sector" value="0">
                                                </div>
                                            </div>
										  ...
										  <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  class="touchspin form-control color" data-bts-postfix="%"  name="e_N6" id="e_N6" placeholder="Reduction in the transport" value="0">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  class="touchspin form-control color" data-bts-postfix="%" name="e_N11" id="e_N11" placeholder="Reduction in industry" value="2" onchange="ResultBalancer()">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="lastName1"><i class="ficon bx bxs-bolt"></i> Replace gas/coal use in the household by electricity </label>
                                                    <input type="text"  class="touchspin form-control color" data-bts-postfix="%"  name="e_N12" id="e_N12" placeholder="Reduction in the transport" value="0">
                                                </div>
                                            </div>
                                              ...
                                              <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  class="touchspin form-control color" data-bts-postfix="%"  name="e_N13" id="e_N13" placeholder="Reduction in the transport" value="26" onchange="ResultBalancer()">
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="boxy">
                                              ...
                                              <div class="form-group"  style="width:90%;margin-left:4%;">
                                                    <label>Wind</label>
                                                   <input type="text"  class="touchspin form-control balancer color"  id="em_J21" name="J21" data-bts-postfix="%" value="12" onblur="EnergyCheck('em_J21')" onfocus = "sessionStorage.setItem('em_J21', this.value)">
                                                </div>
                                                <div class="form-group"  style="width:90%;margin-left:4%;">
                                                    <label>Solar</label>
                                                   <input type="text"  class="touchspin form-control balancer color" id="em_J22" name="J22" data-bts-postfix="%" value="3" onblur="EnergyCheck('em_J22')" onfocus = "sessionStorage.setItem('em_J22', this.value)">
                                                </div>
                                                <div class="form-group"  style="width:90%;margin-left:4%;">
                                                    <label>Hydro</label>
                                                   <input type="text"  class="touchspin form-control balancer color" id="em_J23" name="J23" data-bts-postfix="%" value="18" onblur="EnergyCheck('em_J23')" onfocus = "sessionStorage.setItem('em_J23', this.value)">
                                                </div>
                                                 <div class="form-group"  style="width:90%;margin-left:4%;">
                                                    <label>Biofuels</label>
                                                   <input type="text"  class="touchspin form-control balancer color" id="em_J24" name="J24" data-bts-postfix="%" value="3" onblur="EnergyCheck('em_J24')" onfocus = "sessionStorage.setItem('em_J24', this.value)">
                                                </div>
                                          ...
                                          <br>
                                            ...
                                            <h6 class="pb-80"><b style="font-style:italic;">Non-renewable</b></h6>
                                             ...
                                             <div class="form-group">
                                                    <label>Nuclear</label>
                                                   <input type="text"  class="touchspin form-control balancer color" id="em_J25" name="J25" data-bts-postfix="%" value="4" onblur="EnergyCheck('em_J25')" onfocus = "sessionStorage.setItem('em_J25', this.value)">
                                                </div>
                                                <div class="form-group">
                                                    <label>Fossil</label>
                                                   <input type="text"  class="touchspin form-control balancer color" id="em_J26" name="J26" data-bts-postfix="%" value="60" onblur="EnergyCheck('em_J26')" onfocus = "sessionStorage.setItem('em_J26', this.value)">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" id="L30" name="L30" value="74" data-bts-postfix="%" onchange="Quest('fossil fuels',this.value,document.getElementById('ff').innerHTML,'<%=code%>','<%=version%>','<%=stanza%>');">

                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group" id="fossil-import-keyboard">
                                                     <label for="lastName1">Source </label>
                                                     <div class="btn-group btn-group-toggle mb-1" data-toggle="buttons" style="position: relative;display: flex;flex-wrap: wrap;align-items: stretch;width: 100%;">
                                                    <label class="btn btn-a " id="labelFossilA" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsfossil" id="fossila" value="A" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('A','ff');Quest('fossil fuels',document.getElementById('L30').value,'A','<%=code%>','<%=version%>','<%=stanza%>');"> A
                                                    </label>
                                                    <label class="btn btn-b " id="labelFossilB" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsfossil" id="fossilb" value="B" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('B','ff');Quest('fossil fuels',document.getElementById('L30').value,'B','<%=code%>','<%=version%>','<%=stanza%>');"> B
                                                    </label>
                                                    <label class="btn btn-c" id="labelFossilC" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsfossil" id="fossilc" value="C" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('C','ff');Quest('fossil fuels',document.getElementById('L30').value,'C','<%=code%>','<%=version%>','<%=stanza%>');"> C
                                                    </label>
                                                    <label class="btn btn-d" id="labelFossilD" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsfossil" id="fossild" value="D"style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('D','ff');Quest('fossil fuels',document.getElementById('L30').value,'D','<%=code%>','<%=version%>','<%=stanza%>');"> D
                                                    </label>
                                                    <label class="btn btn-w active" id="labelFossilW" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsfossil" id="fossilworld" value="W" onchange="Source('WORLD','ff');Clean('fossil fuels','<%=version %>');" checked style="padding:0.1rem 0.7rem;line-height: 2.5rem;"> WORLD
                                                    </label>
                                                </div>
                                                </div>
                                            </div>
                                          ...
                                          <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" id="L31" name="L31" value="0" data-bts-postfix="%" onchange="Quest('biofuels',this.value,document.getElementById('bb').innerHTML,'<%=code%>','<%=version%>','<%=stanza%>');">

                                                </div>
                                            </div>
                                             <div class="col-sm-6">
                                                <div class="form-group" id="bio-import-keyboard">
                                                     <label for="lastName1">Source </label>
                                                     <div class="btn-group btn-group-toggle mb-1" data-toggle="buttons" style="position: relative;display: flex;flex-wrap: wrap;align-items: stretch;width: 100%;">
                                                    <label class="btn btn-a " id="labelBioA" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsbio" id="biofuela" value="A" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('A','bb');Quest('biofuels',document.getElementById('L31').value,'A','<%=code%>','<%=version%>','<%=stanza%>');"> A
                                                    </label>
                                                    <label class="btn btn-b " id="labelBioB" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsbio" id="biofuelb" value="B" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('B','bb');Quest('biofuels',document.getElementById('L31').value,'B','<%=code%>','<%=version%>','<%=stanza%>');"> B
                                                    </label>
                                                    <label class="btn btn-c" id="labelBioC" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonsbio" id="biofuelc" value="C" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('C','bb');Quest('biofuels',document.getElementById('L31').value,'C','<%=code%>','<%=version%>','<%=stanza%>');"> C
                                                    </label>
                                                    <label class="btn btn-d" id="labelBioD" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonsbio" id="biofueld" value="D" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('D','bb');Quest('biofuels',document.getElementById('L31').value,'D','<%=code%>','<%=version%>','<%=stanza%>');"> D
                                                    </label>
                                                    <label class="btn btn-w active" id="labelBioW" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonsbio" id="biofuelworld" value="W" onchange="Source('WORLD','bb');Clean('biofuels','<%=version %>');" checked style="padding:0.1rem 0.7rem;line-height: 2.5rem;"> WORLD
                                                    </label>
                                                </div>
                                                </div>
                                            </div>
                                          ...
                                          <div class="col-sm-6">
                                                <div class="form-group" id="elec-import-keyboard">
                                                    <label style="font-size:11px;">% energy in this category imported <b id="ec">(Source World)</b></label>
                                                   <input type="text"  class="touchspin form-control color" id="L32" name="L32" value="0" data-bts-postfix="%"  onchange="Quest('electricity',this.value,document.getElementById('ec').innerHTML,'<%=code%>','<%=version%>','<%=stanza%>');">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                     ...
                                                     <label class="btn btn-a " id="labelElecA" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonselec" id="ela" value="A" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('A','ec');Quest('electricity',document.getElementById('L32').value,'A','<%=code%>','<%=version%>','<%=stanza%>');"> A
                                                    </label>
                                                    <label class="btn btn-b " id="labelElecB" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonselec" id="elb" value="B" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('B','ec');Quest('electricity',document.getElementById('L32').value,'B','<%=code%>','<%=version%>','<%=stanza%>');"> B
                                                    </label>
                                                    <label class="btn btn-c" id="labelElecC" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"  class="form-control" name="checkbuttonselec" id="elc" value="C" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('C','ec');Quest('electricity',document.getElementById('L32').value,'C','<%=code%>','<%=version%>','<%=stanza%>');"> C
                                                    </label>
                                                    <label class="btn btn-d" id="labelElecD" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonselec" id="eld" value="D" style="padding:0.1rem 0.7rem;line-height: 2.5rem;" onchange="Source('D','ec');Quest('electricity',document.getElementById('L32').value,'D','<%=code%>','<%=version%>','<%=stanza%>');"> D
                                                    </label>
                                                    <label class="btn btn-w active" id="labelElecW" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonselec" id="elworld" value="W" onchange="Source('WORLD','ec');Clean('electricity','<%=version %>');" checked style="padding:0.1rem 0.7rem;line-height: 2.5rem;"> WORLD
                                                    </label>
                                                </div>
                                                </div>
                                            </div>
                            ...
                            <div id="collapse6" role="tabpanel" aria-labelledby="headingCollapse2" class="collapse">
                                ...
                                <div class="col-md-3" style="min-height:220px;margin-top:0.5em!important;">
                                   ...
                                   <div class="col-md-3" style="min-height:220px;margin-top:0.5em!important;">
                                        ...
                                        <canvas id="bar-chart-sotto-due"  style="height:220px; position: relative; z-index:99" class="chartjs-render-monitor"></canvas>
                                        <!-- <canvas id="bar-chart-sotto-due-limits"  style="height:220px; position: absolute; z-index:1; top:0" class="chartjs-render-monitor"></canvas> -->
                                   </div>
        ...
        <div class="w-100" id="secaw"></div>
             <div class="col-sm" style="margin-top:1em; float: left; background-color:#236e89; margin-right:0.3em; width: 46px; color:#1c82ad;" id="secaparent">.</div>
        <div class="col-6 col" style="margin-top:1em;" id="seca">A</div>

         <div class="w-100" id="secbw"></div>
             <div class="col-sm" style="margin-top:1em; float: left; background-color:#1c82ad; margin-right:0.3em; width: 46px; color:#1c82ad; " id="secbparent">.</div>
        <div class="col-6 col" style="margin-top:1em;" id="secb">B</div>

         <div class="w-100" id="seccw"></div>
            <div class="col-sm" style="margin-top:1em; float: left; background-color:#A9B9CF; margin-right:0.3em; width: 46px; color:#A9B9CF;" id="seccparent">.</div>
        <div class="col-6 col" style="margin-top:1em;" id="secc">C</div>

         <div class="w-100" id="secdw"></div>
             <div class="col-sm" style="margin-top:1em; float: left; background-color:#EBEEF2; margin-right:0.3em; width: 46px; color:#EBEEF2;" id="secdparent">.</div>
        <div class="col-6 col" style="margin-top:1em;" id="secd">D</div>

         <div class="w-100"></div>
             <div class="col-sm" style="margin-top:1em; float: left; background-color:#62768C; margin-right:0.3em; width: 46px; color:#62768C;">.</div>
        <div class="col-6 col-sm" style="margin-top:1em;" id="sece">World</div>
  	...
  	<!--	</div>     -->
                        ...
                        <div class="card collapse-header">
                            ...
                            <div id="collapse8" role="tabpanel" aria-labelledby="headingCollapse8" class="collapse">
                                <div class="card-content">
                                    <div class="card-body">
									<div class="eff" style="width:100%;color:#008000;"><i class="bx bx-subdirectory-right"></i> EFFICIENCY OF CONSUMED FOOD <small></small></div>
                                                ...
                                                <span class="align-middle text-muted" style="font-weight:600;">Carbon <br>(kg CO2/cap/day) </span>
                                                </div>
												</div>
		                                       ...
		                                       <div class="col-sm celle" >
                                                ...
                                                <span class="align-middle text-muted" style="font-weight:600;">Land <br>(m2/cap/day)</span>
                                                </div>
		                                       </div>
		                                       ...
		                                       <div class="col-sm celle" >
                                                ...
                                                <span class="align-middle text-muted" style="font-weight:600;">Green Water <br>(l/cap/day)</span>
                                                </div>
		                                      </div>
                                                ...
                                                <span class="align-middle text-muted" style="font-weight:600;">Blue Water <br>(l/cap/day)</span>
                                                </div>
		                                       </div>
	...
	<div class="eff" style="width:100%;color:#FDAC41;margin-top:10px;"><i class="bx bx-subdirectory-right"></i> EFFICIENCY OF CONSUMED ENERGY <small></small></div>
    <div class="row">
	<div class="col-sm celle" >
		                                        <div class="user-analytics">
                                                <img class="mr-25 align-middle" src="icon/cb.png" style="width:1.5rem;" />
 ...
 localStorage.setItem("stanza", stanza);
    ...
    <!-- BEGIN: Page JS-->
        ...
        <script src="app-assets/js/multi/scripts/charts/grafici-sopra-onclick.js"></script>
        <script src="app-assets/js/multi/scripts/charts/grafici-sotto-onclick.js"></script>
...
setInterval(function(){
	  ...
	  VMRequest('<%=region %>','<%=code %>','<%=stanza%>','Mf');
...
setInterval(function(){
	 ...
	 VMRequest('<%=region %>','<%=code %>','<%=stanza%>','Pb');
...
setInterval(function(){
	...
	VMRequest('<%=region %>','<%=code %>','<%=stanza%>','De');
...
setInterval(function(){
 ...
 VMRequest('<%=region %>','<%=code %>','<%=stanza%>','Ff');
...
setInterval(function(){
  ...
  VMRequest('<%=region %>','<%=code %>','<%=stanza%>','Bf');
...
setInterval(function(){
 	  ...
 	  VMRequest('<%=region %>','<%=code %>','<%=stanza%>','Ec');
