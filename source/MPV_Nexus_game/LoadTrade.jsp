                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2"><img src="icon/avatar.jpg" style="width:48px;"> <a href="login.html" title="Return to home">Welcome to Nexus Game!</a></h4>
                                            </div>
                                        </div>
...
<div class="divider">
                                                   ...
                                                   <form action="magic.jsp" methos="Post">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-bold-600" for="exampleInputPassword1">Version</label>
                                                        <select class="form-control" id="SelectVersionGame"  onChange="Vis(this.value);" name="Version">
                                                        <option> -- CHOOSE VERSION OF THE GAME --</option>
                                                        <option value="SP1">Single Player Level 1 (SP1)</option>
                                                        <option value="SP2">Single Player Level 2 (SP2)</option>
                                                        <option value="MP">Multiplayer (MP)</option>
                                                        </select>
                                                    </div>
                                                      <div class="form-group" id="Role">
                                                        <label class="text-bold-600" for="exampleInputPassword1">Role</label>
                                                        <select class="form-control" id="SelectRegionLogin"  name="SelectRegionLogin" onChange="Vis(this.value);" name="Region">
                                                        <option value="regionA"> -- CHOOSE ROLE IN THE GAME --</option>
                                                        <option value="regionA">Region A (Austria,  Ireland, Netherlands, Slovakia, Slovenia)</option>
                                                        <option value="regionB">Region B (Bulgaria, Estonia, Finland, Hungary, Latvia, Lithuania, Sweden)</option>
                                                        <option value="regionC">Region C (Belgium, Cyprus, Czech Republic, Germany, Italy)</option>
                                                        <option value="regionD">Region D (France, Poland, Romania, Spain)</option>
                                                        <option>Facilitator (Only Multiplayer Version)</option>
                                                        </select>
                                                    </div>
                                                    <input type="hidden" name="Action" value="Login" />
                                                    <button type="submit" class="btn btn-primary glow w-100 position-relative" style="margin-top:20px;" id="LoginButton" onclick="localStorage.clear(); loginStorage();">Start the game<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                                </form>
                                                <hr>
   ...
   <!-- BEGIN: Vendor JS-->
    ...
    <script src="app-assets/vendojquery.sticky.js"></script>
    <!-- END: Page Vendor JS-->
