...
In seguito, quando si farà click su una regione, localSaveData() verrà chiamato dal click
e permetterà di salvare i dati associati alla regione selezionata dal click.
*/
localSaveData();
...
function localLoadData() {
	...
	//----------------------------------------------------------------------------------------
		...
		alert("Nessun dato registrato in precedenza per questa regione");
	}
}