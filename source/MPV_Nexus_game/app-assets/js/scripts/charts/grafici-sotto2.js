...
var "rgba(234,216,49,0.5)" = $warning;
var "rgba(226,18,18,0.5)" = $danger;
var verde = $success;
var blu = $primary;
  		  ...
  		  var horizontalchartData = {
  		   labels: [""],
  		    ...
  		    },
  		    {
  			      ...
  			      data: [0],
  			      backgroundColor: "rgba(234,216,49,0.5)",
  			      borderColor: "transparent"
  			    },
  			    {
  				      label: ["Phisical Limit"],
  				      data: [0],
  				      backgroundColor: "rgba(226,18,18,0.5)",
  				      borderColor: "transparent"
  				    }]
  		  };
    	    	...
    	    	if(number<0){
    	    		...
    	    		if((grand_total_abs<=0.09)&&(grand_total_abs>0.04)){
    	    			...
    	    			//console.log("CF TOTAL ABS SECONDO IF CASO ok1"+grand_total_abs);
    	    				...
    	    				//	console.log("WFB TOTAL NUMERO POSITIVO	"+grand_total);
    	    					}
    	    				} 
    	    	else {
    	    		}
				console.log("WFB TOTAL % SOTTO AL TITOLO SOTTO	"+grand_total);
...
//  			//////console.log("MULCHING PARSE: "+Mulching_parse);
  	...
  	//----PERCENTUALE SOTTO AL TITOLO---
  	var grand_total_ante = Math.round(Number(dataLF_food_int)+Number(datoLFen_internal)-initial_grafici_sotto_lf)/initial_grafici_sotto_lf;
  	var grand_total_round = (grand_total_ante);
  	var number= Number(grand_total_round);
  	var grand_total = 0;
  	var grand_total_abs = 0;
  ...
  //var sumLFfooden = Math.round(parseInt(Number(dataLF_food_int)+Number(datoLFen_internal)));
  		  ...
  		  var sustlf = [0, sustainableLF];
  		  var physlf = [0, physicalLF];
  		//  var datiaggbar2 = [0,0];
  		
  		  horizontalChart2.data.datasets[0].data = datiaggbar;
  		horizontalChart2.data.datasets[1].data = sustlf;
  		horizontalChart2.data.datasets[2].data = physlf;
...
//  			//////console.log("MULCHING PARSE: "+Mulching_parse);
 ...
 var bio_final_WFgreen_ext = total_bio_user*(biofuels_parse)*(Number(RC_D_WFgreen_Biofuel)*0.27)/1000;
  	  ...
  	  //////////////////////////////////////////////////////////////////
  	  		  /////////////////////////////////////////////////////////////////	
  	  		var titoloWFg_sotto = parseFloat(Number(dataWFgreen_food_int)+Number(datoWFgreen_en_internal)).toFixed(1);
  	    	document.getElementById("GT3_sotto").innerHTML = titoloWFg_sotto;
  	  		
  	       	//----PERCENTUALE SOTTO AL TITOLO---
  	    	var grand_total_ante = Math.round(Number(dataWFgreen_food_int)+Number(datoWFgreen_en_internal)-initial_grafici_sotto_wfg)/initial_grafici_sotto_wfg;
  	    	console.log("INITIAL VALUE WFG PER PERCENTUALE TITOLO: "+initial_grafici_sotto_wfg);
  	    	//console.log("VARIABILI DELLA PERCENTUALE WFG: DATO FOOD "+dataWFgreen_food_int);
  	    	//console.log("VARIABILI DELLA PERCENTUALE WFG: DATO EN "+datoWFgreen_en_internal);
  	    	//console.log("VARIABILI DELLA PERCENTUALE WFG: DATO INIT "+initial_grafici_sotto_wfg);
  ...
  var sumWFgfooden = Math.round(parseInt(Number(dataWFgreen_food_int)+Number(datoWFgreen_en_internal)));
  		...
  		//  var datiaggbar2 = [0,0];
  		var sustwfg = [0, sustainableWFG];
  		var physwfg = [0, physicalWFG];
  		  horizontalChart3.data.datasets[0].data = datiaggbar;
  		  horizontalChart3.data.datasets[1].data = sustwfg;
  		  horizontalChart3.data.datasets[2].data = physwfg;
...
//  			//////console.log("MULCHING PARSE: "+Mulching_parse);
    	...
    	//----PERCENTUALE SOTTO AL TITOLO---
    	var grand_total_ante = Math.round(Number(dataWFblue_food_int)+Number(datoWFblue_en_internal)-initial_grafici_sotto_wfb)/initial_grafici_sotto_wfb;
    	var grand_total_round = (grand_total_ante);
    	var number= Number(grand_total_round);
    	var grand_total = 0;
    	var grand_total_abs = 0;
    	...
    	document.getElementById("percent4_sotto").innerHTML = grand_total + "% above initial value"; 
  		...
  		//////////////////////////////////////////////////////////////////
  		  ...
  		  var sustwfb = [0, sustainableWFB];
  		  var physWFB = [0, physicalWFB];
  		 // var datiaggbar2 = [0, 0];
  		
  		  horizontalChart4.data.datasets[0].data = datiaggbar;
  		  horizontalChart4.data.datasets[1].data = sustwfb;
  		  horizontalChart4.data.datasets[2].data = physWFB;
