...
var blu = $primary;
  ...
  //Doughnut Chart SECURITY
    ...
    var doughnutchartOptions2 = {
      ...
      title: {
        display: true,
        text: ['Security Food', 'Production of food (kcal/cap/day)']
      },
      legend: {
          display: false
      },
...
//  	  	////console.log("MULCHING PARSE: "+Mulching_parse);
 ...
 //alert("RISULTATI plant: "+plantGlobalD+" "+plantGlobalC+" "+plantGlobalB+" "+plantGlobalA);
  ...
  var calcolopercfood2 = calcolopercfood1+(sumfoodsecurityWORLD);
   ...
   percentage_food = parseFloat(((calcolopercfood1)/(calcolopercfood2))*100).toFixed(2);
   if (percentage_food == 100.00) {
	...
	A_obj = JSON.parse(localStorage.getItem("regionADataOutput"));
  	...
  	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
  		...
  		WORLD_obj["WORLD_A_security_food"] = world_food;
  	}
  	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
  		...
  		WORLD_obj["WORLD_B_security_food"] = world_food;
  	}
  	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
  		...
  		WORLD_obj["WORLD_C_security_food"] = world_food;
  	}
  	else {
  		...
  		WORLD_obj["WORLD_D_security_food"] = world_food;
  	}
...
var SUMA = Number(FOSSILA2)+Number(BIOA2)+Number(ELECA2);
   ...
   var calcolopercen2 = calcolopercen1+(SUMWORLD);
    ...
    percentage_energy = parseFloat(((calcolopercen1)/(calcolopercen2))*100).toFixed(2);
    if (percentage_energy == 100.00) {
	...
	local_energy = Number(local_energy);
  	...
  	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
  		...
  		WORLD_obj["WORLD_A_security_energy"] = world_en;
  	}
  	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
  		...
  		WORLD_obj["WORLD_B_security_energy"] = world_en;
  	}
  	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
  		...
  		WORLD_obj["WORLD_C_security_energy"] = world_en;
  	}
  	else {
  		...
  		WORLD_obj["WORLD_D_security_energy"] = world_en;
  	}
