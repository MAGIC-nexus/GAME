...
//  			//////console.log("MULCHING PARSE: "+Mulching_parse);
  		...
  		var diary_WFgreen = (diaryA)*(diaryC);
  			...
  			//------------------------------------------------------------------------------------------------------------------
  			var plantbasedA = plantbased*(1-Number(fip));
  			console.log("REGION C PLANTBASED A: "+plantbasedA);
  			var plantbasedB = ((YeldWFg+Mulch)*Rainfed)+Deficit;
  			console.log("REGION C PLANTBASED B: "+(YeldWFg+Mulch)+" - RAINFED: "+Rainfed+" DEFICIT: "+Deficit);

  			var plantbasedC = Number(RC_WFgreen_Plant)*(1-Number(plantbasedB));	
  			console.log("REGION C PLANTBASED C: "+RC_WFgreen_Plant+" <-RC_WFG_plant ->"+(1-Number(plantbasedB)));

  			var plant_WFgreen = Number(plantbasedA)*Number(plantbasedC);
  			console.log("REGION C PLANTBASED WFGREEN: "+plant_WFgreen);
  		...
  		//---------------------------------------------------------------------------------------------------------------------
  		meat_WFgreen = Number(meat_WFgreen);
  		var add1 = (plant_WFgreen)+(meat_WFgreen);
  		console.log("PLANT WFGREEN "+plant_WFgreen+" MEAT WFGREEN "+meat_WFgreen+" DIARY WFGREEN "+diary_WFgreen);
