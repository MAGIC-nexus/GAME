...
//----------------------------------------------------------------------------------------------  	
var titoloCF = (datoCFen_external+dataCF_food_ext)+(datoCFen_internal+dataCF_food_int);
...
//----------------------------------------------------------------------------------------------  	
var titoloLF = (datoLFen_external+dataLF_food_ext)+(datoLFen_internal+dataLF_food_int);
console.log("TITOLO SOPRA LF: "+titoloLF);
console.log("----------------------------------------------------------------------------------");
//----------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------  	
var titoloWFgreen = (datoWFgreen_en_external+dataWFgreen_food_ext)+(datoWFgreen_en_internal+dataWFgreen_food_int);
...
document.getElementById("percent3").innerHTML = parseFloat((dataWFgreen_food_int+1087 - 4715/4715)/100).toFixed(2) + "% above the initial value";
}
...
//----------------------------------------------------------------------------------------------  	
var titoloWFblue = (datoWFblue_en_external+dataWFblue_food_ext)+(datoWFblue_en_internal+dataWFblue_food_int);
...
//OTTENGO LA PERCENTUALE BASE (% * calorie+waste)
	  ...
	  var plantbased = parseFloat((plant1*cal_waste)/100).toFixed(2);
	  var YeldCF = Number(Gap_Yeld_parse*YG_closing_CF);
	  var Mulch = Number(Mulching_parse*Mulching_CF);
	  var Deficit = Number(Full_Deficit_parse*Deficit_Mul_Drip_CF);
...
var plantbasedB = Number(YeldCF)+Number(Mulch)+Number(Deficit);
var plantbasedC = Number(RA_CF_Plant)*(1-plantbasedB);	
var plant_cf = parseFloat(Number(plantbasedA*plantbasedC)).toFixed(2);

//MEAT:	
var meatbasedA = parseFloat(meatbased*(1-fim)).toFixed(2); 
var meatbasedB = Number(YeldCF)+Number(Mulch)+Number(Deficit);
var meatbasedC = Number(RA_CF_Meat)*(1-meatbasedB);
var meat_cf = Math.floor(parseFloat(Number(meatbasedA)*Number(meatbasedC)).toFixed(2));


//DIARY:
var diaryA = parseFloat(Number(diarybased)*Number(1-fid)).toFixed(2); 
var diaryB = Number(YeldCF)+Number(Mulch)+Number(Deficit);
var diaryC = Number(RA_CF_Diary)*(1-diaryB);
var diary_cf = Math.ceil(parseFloat(Number(diaryA)*Number(diaryC)).toFixed(2));	 

  
var add1 = Number(plant_cf)+Number(meat_cf);
var add2 = Number(add1)+Number(diary_cf);
var result = Number(add2);
var dataCF_food_int_parse = Math.floor(result);
var dataCF_food_int = parseFloat(dataCF_food_int_parse).toFixed(2);
  

//CALCOLO IL VALORE PER LE SOMME DI FOOD CF EXTERNAL:
	  var plantres_cf_e = Number(plantbased)*Number(fip);
	  var plantres_cf_ext = parseFloat(Number(plantres_cf_e)*Number(WORLD_plant_cf)).toFixed(2);
	  //console.log("PLANT EXT: "+plantres_cf_ext);	
	  var meatres_cf_e = Number(meatbased)*Number(fim);
	  var meatres_cf_ext = parseFloat(Number(meatres_cf_e)*Number(WORLD_meat_cf)).toFixed(2);
	  //console.log("MEAT EXT: "+meatres_cf_ext);	
	  var diaryres_cf_e = Number(diarybased)*Number(fid);
	  var diaryres_cf_ext = parseFloat(Number(diaryres_cf_e)*Number(WORLD_diary_cf)).toFixed(2);
	  //console.log("DIARY EXT: "+diaryres_cf_ext);	
	  
	  var add3 = Number(plantres_cf_ext)+Number(meatres_cf_ext);
	  var add4 = Number(add3)+Number(diaryres_cf_ext);
	  var result2 = Number(add4);
	  var dataCF_food_ext_parse = Math.floor(result2);
	  var dataCF_food_ext = parseFloat(dataCF_food_ext_parse).toFixed(2);
...
//////////////////// CALCOLO ENERGY ///////////////////////////////
	  ...
	  //caoclo valori iniziali di BIOFUEL USER:	  
		...
		var e_i = parseFloat((1-Number(red_ind_parse))*el_ind).toFixed(2);
	  	  ...
	  	  ///CALCOLO VALORI FINALI CF INTERNAL///
	  	
	  	  var fossil_final_cf = Number(energy_fossil_val)*(Number(RA_CF_Fossil)*0,25)/1000;
	  	  var bio_final_cf = Number(energy_bio_val)*(Number(RA_CF_Biofuel*0,27))/1000;
	
var elec1= Number(PER_A_Wind)*Number(RA_CF_Wind);

var elec2 =Number(PER_A_Solar)*Number(RA_CF_Solar);
var elec3 =parseFloat(Number(PER_A_Hydro)*Number(RA_CF_Hydro)).toFixed(2);
var elec4 =Number(PER_A_Biofuel)*Number(RA_CF_Biofuel);
var elec5 =Number(PER_A_Nuclear)*Number(RA_CF_Nuclear);
var elec6 =parseFloat(Number(PER_A_Fossil)*Number(RA_CF_Fossil)).toFixed(2); 	
...
var elec_final_cf = parseFloat(Number(energy_elec_val)*Number(electricity_sum)/1000).toFixed(2); 	  

	  	  var add1e = Number(fossil_final_cf)+Number(bio_final_cf)+0.74;
	  	  var add2e = Number(add1e)+Number(elec_final_cf);
	  	  var datoCFen_internal = parseFloat(Number(add2e)).toFixed(2);
	  
	  	 ///CALCOLO VALORI FINALI CF EXTERNAL///
	  	  
	  	  var fossil_final_cf_ext = parseFloat(Number(total_fossil_user)*((Number(RC_D_CF_Fossil)*0.25)/1000)).toFixed(2);
	  	  var bio_final_cf_ext = parseFloat(Number(total_bio_user)*(Number(RC_D_CF_Biofuel*0.27))/1000).toFixed(2); 	
	  	  var elec7= Number(PER_A_Wind)*Number(RC_D_CF_Wind);
	  	var elec8 =Number(PER_A_Solar)*Number(RC_D_CF_Solar);
	  	var elec9 =Number(PER_A_Hydro)*Number(RC_D_CF_Hydro);
	  	var elec10 =Number(PER_A_Biofuel)*Number(RC_D_CF_Biofuel);
	  	var elec11 =Number(PER_A_Nuclear)*Number(RC_D_CF_Nuclear);
	  	var elec12 =Number(PER_A_Fossil)*Number(RC_D_CF_Fossil); 	 	  
	  	...
	  	var elec_final_cf_ext = (Number(energy_elec_val)*Number(elec_sum_due))/1000;	  	  

	  	 var add3e = Number(fossil_final_cf_ext)+Number(bio_final_cf_ext);
	  	  var add4e = Number(add3e)+Number(elec_final_cf_ext);	 
		  var datoCFen_external = parseFloat(Number(add4e)-7).toFixed(2);	
		  var titoloCF = parseFloat(Number(datoCFen_external)+Number(datoCFen_internal)).toFixed(2);		  
...
//OTTENGO LA PERCENTUALE BASE (% * calorie+waste)
	  ...
	  var plantbased = parseFloat((plant1*cal_waste)/100).toFixed(2);
	  var YeldLF = Number(Gap_Yeld_parse*YG_closing_LF);
	  var Mulch = Number(Mulching_parse*Mulching_LF);
	  var Deficit = Number(Full_Deficit_parse*Deficit_Mul_Drip_LF);
...
//CALCOLO IL VALORE PER LE SOMME DI FOOD:
	 ...
	 //CALCOLO IL VALORE PER LE SOMME DI FOOD CF INTERNAL:
	  //PLANT:
var plantbasedA = parseFloat(plantbased*(1-fip)).toFixed(2);  
var plantbasedB = Number(YeldLF)+Number(Mulch)+Number(Deficit);
var plantbasedC = Number(RA_LF_Plant)*(1-plantbasedB);	
var plant_lf = parseFloat(Number(plantbasedA*plantbasedC)).toFixed(2);

//MEAT:	
var meatbasedA = parseFloat(Number(meatbased)*Number(1-fim)).toFixed(2); 
var meatbasedB = Number(YeldLF)+Number(Mulch)+Number(Deficit);
var meatbasedC = Number(RA_LF_Meat)*(1-meatbasedB);
var meat_lf = parseFloat(Number(meatbasedA)*Number(meatbasedC)/10).toFixed(2);


//DIARY:
var diaryA = parseFloat(Number(diarybased)*Number(1-fid)).toFixed(2); 
var diaryB = Number(YeldLF)+Number(Mulch)+Number(Deficit);
var diaryC = Number(RA_LF_Diary)*(1-diaryB);
var diary_lf = parseFloat(Number(diaryA)*Number(diaryC)).toFixed(2);	 

  
var add1 = Number(plant_lf)+Number(meat_lf);
var add2 = Number(add1)+Number(diary_lf);
var result = Number(add2);
var dataLF_food_int_parse = Math.ceil(result);
var dataLF_food_int = parseFloat(dataLF_food_int_parse).toFixed(2);


//CALCOLO IL VALORE PER LE SOMME DI FOOD LF EXTERNAL:

var plantres_lf_ext = Number(plantbased)*[Number(fip)*Number(WORLD_plant_lf)];
var meatres_lf_ext = Number(meatbased)*[Number(fim)*Number(WORLD_meat_lf)];
var diaryres_lf_ext = Number(diarybased)*[Number(fid)*Number(WORLD_diary_lf)];	  

var add3 = Number(plantres_lf_ext)+Number(meatres_lf_ext);
var add4 = Number(add3)+Number(diaryres_lf_ext);
var result2 = Number(add4);
var dataLF_food_ext_parse = parseFloat(result2).toFixed(2);
var dataLF_food_ext = parseFloat(dataLF_food_ext_parse).toFixed(2);
...
var somma_valori_tr = Number(fossil_tr+bio_tr+el_tr);
////console.log("Fossil IND:"+fossil_ind+" - FOSSIL TR: "+fossil_tr+" - FOSSIL S: "+fossil_s+" - FOSSIL HOUSE: "+fossil_house);
// //console.log("TOTALE FOSSIL I-TR-S-H"+somma_valori_fossil_itsh);
var somma_valori_ind = Number(parseFloat(fossil_ind+bio_ind+el_ind).toFixed(2));
var somma_valori_s = Number(parseFloat(fossil_s+bio_s+el_s).toFixed(2));
var somma_valori_house = Number(parseFloat(fossil_house+bio_house+el_house).toFixed(2));
//FINE CONSUMPTION  
...
var fossil_final_lf = Number(energy_fossil_val)*(Number(RA_LF_Fossil)*0.25)/1000;

var bio_final_lf = Number(energy_bio_val)*(Number(RA_LF_Biofuel*0.27))/1000;
var elec1= Number(PER_A_Wind)*Number(RA_LF_Wind);
var elec2 =Number(PER_A_Solar)*Number(RA_LF_Solar);
var elec3 =parseFloat(Number(PER_A_Hydro)*Number(RA_LF_Hydro)).toFixed(2);
var elec4 =Number(PER_A_Biofuel)*Number(RA_LF_Biofuel);
var elec5 =Number(PER_A_Nuclear)*Number(RA_LF_Nuclear);
var elec6 =parseFloat(Number(PER_A_Fossil)*Number(RA_LF_Fossil)).toFixed(2); 	

var elec1add = Number(elec1)+Number(elec2);
var elec2add = Number(elec3)+Number(elec4);
var elec3add = Number(elec5)+Number(elec6);
var electricity_sum = Number(elec1add)+Number(elec2add)+Number(elec3add);
var elec_final_lf = parseFloat(Number(energy_elec_val)*Number(electricity_sum)/1000).toFixed(2);

var add1e = Number(fossil_final_lf)+Number(bio_final_lf);
var add2e = Number(add1e)+Number(elec_final_lf);
var datoLFen_internal = parseFloat(Number(add2e)).toFixed(2);

///CALCOLO VALORI FINALI LF EXTERNAL///

var fossil_final_lf_ext = parseFloat(Number(total_fossil_user)*((Number(RC_D_LF_Fossil)*0.25)/1000)).toFixed(2);
var bio_final_lf_ext = parseFloat(Number(total_bio_user)*(Number(RC_D_LF_Biofuel*0.27))/1000).toFixed(2); 	
var elec7= Number(PER_A_Wind)*Number(RC_D_LF_Wind);
var elec8 =Number(PER_A_Solar)*Number(RC_D_LF_Solar);
var elec9 =Number(PER_A_Hydro)*Number(RC_D_LF_Hydro);
var elec10 =Number(PER_A_Biofuel)*Number(RC_D_LF_Biofuel);
var elec11 =Number(PER_A_Nuclear)*Number(RC_D_LF_Nuclear);
var elec12 =Number(PER_A_Fossil)*Number(RC_D_LF_Fossil); 	 	  

var elec4add = Number(elec1)+Number(elec2);
var elec5add = Number(elec3)+Number(elec4);
var elec6add = Number(elec5)+Number(elec6);
var elec_sum_due = Number(elec4add)+Number(elec5add)+Number(elec6add);
var elec_final_lf_ext = (Number(energy_elec_val)*Number(elec_sum_due))/1000;	  	  

var add3e = Number(fossil_final_lf_ext)+Number(bio_final_lf_ext);
var add4e = Number(add3e)+Number(elec_final_lf_ext);	 
var datoLFen_external = (Number(add4e)-7);	
var titoloLF = parseFloat(Number(datoLFen_external)+Number(datoLFen_internal)).toFixed(2);		  

//console.log("==========FINE ENERGY LF============");	  
