...
if((checkRadioPlant != null)&&(checkRadioPlant.getAttribute('id')=='planta')) {
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUB))/Number(EUA);
		localStorage.setItem("rescfplant", res_cf_plant);
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUC))/Number(EUA);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
	else {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RA_CF_Plant)*(1-localStorage.getItem("A_totCFyeld")));
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUD))/Number(EUA);
		localStorage.setItem("rescfplant", res_cf_plant);
...
//BOTTONE PLANT B
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUA))/Number(EUB);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RB_CF_Plant)*(1-localStorage.getItem("B_totCFyeld")));
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUC))/Number(EUB);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
	else {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RB_CF_Plant)*(1-localStorage.getItem("B_totCFyeld")));
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUD))/Number(EUB);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
}
...
//BOTTONE PLANT C
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUA))/Number(EUC);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RC_CF_Plant)*(1-localStorage.getItem("C_totCFyeld")));
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUB))/Number(EUC);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
	else {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RC_CF_Plant)*(1-localStorage.getItem("C_totCFyeld")));
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUD))/Number(EUC);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
}
...
//BOTTONE PLANT D
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUA))/Number(EUD);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RD_CF_Plant)*(1-localStorage.getItem("D_totCFyeld")));
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUB))/Number(EUD);
		localStorage.setItem("rescfplant", res_cf_plant);
	}
	else  {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RD_CF_Plant)*(1-localStorage.getItem("D_totCFyeld")));
		...
		var res_cf_plant = (plantres_cf_ext*Number(EUC))/Number(EUD);
		localStorage.setItem("rescfplant", res_cf_plant);
...
if((checkRadioMeat != null)&&(checkRadioMeat.getAttribute('id')=='meata')) {
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUB))/Number(EUA);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
		var meatres_cf_ext = Number(meatres_cf_e)*(Number(RA_CF_Meat)*(1-localStorage.getItem("A_totCFyeld")));
		meatres_cf_ext = Number(meatres_cf_ext);

		var res_cf_meat = (meatres_cf_ext*Number(EUC))/Number(EUA);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
	else {
		var meatres_cf_ext = Number(meatres_cf_e)*(Number(RA_CF_Meat)*(1-localStorage.getItem("A_totCFyeld")));
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUD))/Number(EUA);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
}
//MEAT BOTTONE B
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUA))/Number(EUB);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
		var meatres_cf_ext = Number(meatres_cf_e)*(Number(RB_CF_Meat)*(1-localStorage.getItem("B_totCFyeld")));
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUC))/Number(EUB);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
	else {
		var meatres_cf_ext = Number(meatres_cf_e)*(Number(RB_CF_Meat)*(1-localStorage.getItem("B_totCFyeld")));
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUD))/Number(EUB);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
}
//MEAT BOTTONE C
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUA))/Number(EUC);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var meatres_cf_ext = Number(meatres_cf_e)*(Number(RC_CF_Meat)*(1-localStorage.getItem("C_totCFyeld")));
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUB))/Number(EUC);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
	else {
		var meatres_cf_ext = Number(meatres_cf_e)*(Number(RC_CF_Meat)*(1-localStorage.getItem("C_totCFyeld")));
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUD))/Number(EUC);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
}
//BOTTONE MEAT D
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUA))/Number(EUD);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var meatres_cf_ext = Number(meatres_cf_e)*(Number(RD_CF_Meat)*(1-localStorage.getItem("D_totCFyeld")));
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUB))/Number(EUD);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
	else {
		var meatres_cf_ext = Number(meatres_cf_e)*(Number(RD_CF_Meat)*(1-localStorage.getItem("D_totCFyeld")));
		...
		var res_cf_meat = (meatres_cf_ext*Number(EUC))/Number(EUD);
		localStorage.setItem("rescfmeat", res_cf_meat);
	}
}
else {
...
if((checkRadioDiary != null)&&(checkRadioDiary.getAttribute('id')=='diarya')) {
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUB))/Number(EUA);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
		var diaryres_cf_ext = Number(diaryres_cf_e)*(Number(RA_CF_Diary)*(1-localStorage.getItem("A_totCFyeld")));
		diaryres_cf_ext = Number(diaryres_cf_ext);

		var res_cf_diary = (diaryres_cf_ext*Number(EUC))/Number(EUA);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
	else {
		var diaryres_cf_ext = Number(diaryres_cf_e)*(Number(RA_CF_Diary)*(1-localStorage.getItem("A_totCFyeld")));
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUD))/Number(EUA);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
}
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUA))/Number(EUB);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
		var diaryres_cf_ext = Number(diaryres_cf_e)*(Number(RB_CF_Diary)*(1-localStorage.getItem("B_totCFyeld")));
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUC))/Number(EUB);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
	else {
		var diaryres_cf_ext = Number(diaryres_cf_e)*(Number(RB_CF_Diary)*(1-localStorage.getItem("B_totCFyeld")));
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUD))/Number(EUB);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
}
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUA))/Number(EUC);
		localStorage.setItem("rescfdiary", res_cf_diary);
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUB))/Number(EUC);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
	else {
		var diaryres_cf_ext = Number(diaryres_cf_e)*(Number(RC_CF_Diary)*(1-localStorage.getItem("C_totCFyeld")));
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUD))/Number(EUC);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
}
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUA))/Number(EUD);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var diaryres_cf_ext = Number(diaryres_cf_e)*(Number(RD_CF_Diary)*(1-localStorage.getItem("D_totCFyeld")));
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUB))/Number(EUD);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
	else {
		var diaryres_cf_ext = Number(diaryres_cf_e)*(Number(RD_CF_Diary)*(1-localStorage.getItem("D_totCFyeld")));
		...
		var res_cf_diary = (diaryres_cf_ext*Number(EUC))/Number(EUD);
		localStorage.setItem("rescfdiary", res_cf_diary);
	}
}
else {
...
if((checkRadioFossil != null)&&(checkRadioFossil.getAttribute('id')=='fossila')&&(checkregion.getAttribute('id')=='regionB')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RA_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUB))/Number(EUA);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if ((checkRadioFossil.getAttribute('id')=='fossila')&&(checkregion.getAttribute('id')=='regionC')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RA_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUC))/Number(EUA);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if ((checkRadioFossil.getAttribute('id')=='fossila')&&(checkregion.getAttribute('id')=='regionD')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RA_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUD))/Number(EUA);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if((checkRadioFossil != null)&&(checkRadioFossil.getAttribute('id')=='fossilb')&&(checkregion.getAttribute('id')=='regionA')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RA_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUA))/Number(EUB);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if((checkRadioFossil != null)&&(checkRadioFossil.getAttribute('id')=='fossilb')&&(checkregion.getAttribute('id')=='regionC')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RB_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUC))/Number(EUB);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if((checkRadioFossil.getAttribute('id')=='fossilb')&&(checkregion.getAttribute('id')=='regionD')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RB_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUD))/Number(EUB);
	localStorage.setItem("rescffossil", res_cf_fossil);
}

else if((checkRadioFossil != null)&&(checkRadioFossil.getAttribute('id')=='fossilc')&&(checkregion.getAttribute('id')=='regionA')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RB_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUA))/Number(EUC);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if((checkRadioFossil.getAttribute('id')=='fossilc')&&(checkregion.getAttribute('id')=='regionB')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RB_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUB))/Number(EUC);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
	...
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUD))/Number(EUC);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if((checkRadioFossil != null)&&(checkRadioFossil.getAttribute('id')=='fossild')&&(checkregion.getAttribute('id')=='regionA')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RC_D_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUA))/Number(EUD);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if((checkRadioFossil.getAttribute('id')=='fossild')&&(checkregion.getAttribute('id')=='regionB')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RC_D_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUB))/Number(EUD);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else if((checkRadioFossil.getAttribute('id')=='fossild')&&(checkregion.getAttribute('id')=='regionC')) {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RC_D_CF_Fossil)*0.25)/1000;
	var res_cf_fossil = (fossil_final_cf_ext*Number(EUC))/Number(EUD);
	localStorage.setItem("rescffossil", res_cf_fossil);
}
else {
	var fossil_final_cf_ext = total_fossil_user*(fossilf_parse)*(Number(RC_D_CF_Fossil)*0.25)/1000;
...
if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuela')&&(checkregion.getAttribute('id')=='regionB')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RA_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUB))/Number(EUA);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuela')&&(checkregion.getAttribute('id')=='regionC')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RA_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUC))/Number(EUA);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuela')&&(checkregion.getAttribute('id')=='regionD')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RA_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUD))/Number(EUA);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuelb')&&(checkregion.getAttribute('id')=='regionA')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RA_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUA))/Number(EUB);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuelb')&&(checkregion.getAttribute('id')=='regionC')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RB_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUC))/Number(EUB);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if ((checkRadioBio.getAttribute('id')=='biofuelb')&&(checkregion.getAttribute('id')=='regionD')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RB_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUD))/Number(EUB);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuelc')&&(checkregion.getAttribute('id')=='regionA')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RB_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUA))/Number(EUC);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio.getAttribute('id')=='biofuelc')&&(checkregion.getAttribute('id')=='regionB')){
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RB_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUB))/Number(EUC);
	localStorage.setItem("rescfbio", res_cf_bio);
}
	...
	var res_cf_bio = (bio_final_cf_ext*Number(EUD))/Number(EUC);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofueld')&&(checkregion.getAttribute('id')=='regionA')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RC_D_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUA))/Number(EUD);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio.getAttribute('id')=='biofueld')&&(checkregion.getAttribute('id')=='regionB')) {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RC_D_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUB))/Number(EUD);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else if((checkRadioBio.getAttribute('id')=='biofueld')&&(checkregion.getAttribute('id')=='regionC')){
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RC_D_CF_Biofuel)*0.27)/1000;
	var res_cf_bio = (bio_final_cf_ext*Number(EUC))/Number(EUD);
	localStorage.setItem("rescfbio", res_cf_bio);
}
else {
	var bio_final_cf_ext = total_bio_user*(biofuels_parse)*(Number(RC_D_CF_Biofuel)*0.27)/1000;
...
var checkRadioElec = document.querySelector('input[name="checkbuttonselec"]:checked');
if((checkRadioElec != null)&&(checkRadioElec.getAttribute('id')=='ela')&&(checkregion.getAttribute('id')=='regionB')) {
// CORRISPONDE A IMPORT CODE 1
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUB))/Number(EUA);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if((checkRadioElec != null)&&(checkRadioElec.getAttribute('id')=='ela')&&(checkregion.getAttribute('id')=='regionC')) {
// CORRISPONDE A IMPORT CODE 1
	windp = JSON.parse(localStorage.getItem("regionADataInput"))["windp"];
	solarp = JSON.parse(localStorage.getItem("regionADataInput"))["solarp"];
	hydrop =  JSON.parse(localStorage.getItem("regionADataInput"))["hydrop"];
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUC))/Number(EUA);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if((checkRadioElec != null)&&(checkRadioElec.getAttribute('id')=='ela')&&(checkregion.getAttribute('id')=='regionD')) {
// CORRISPONDE A IMPORT CODE 1
	windp = JSON.parse(localStorage.getItem("regionADataInput"))["windp"];
	solarp = JSON.parse(localStorage.getItem("regionADataInput"))["solarp"];
	hydrop =  JSON.parse(localStorage.getItem("regionADataInput"))["hydrop"];
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUD))/Number(EUA);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if((checkRadioElec != null)&&(checkRadioElec.getAttribute('id')=='elb')&&(checkregion.getAttribute('id')=='regionA')) {
	windp = JSON.parse(localStorage.getItem("regionADataInput"))["windp"];
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUA))/Number(EUB);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if((checkRadioElec != null)&&(checkRadioElec.getAttribute('id')=='elb')&&(checkregion.getAttribute('id')=='regionC')) {
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUC))/Number(EUB);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if ((checkRadioElec.getAttribute('id')=='elb')&&(checkregion.getAttribute('id')=='regionD')) {
	windp = JSON.parse(localStorage.getItem("regionBDataInput"))["windp"];
	solarp = JSON.parse(localStorage.getItem("regionBDataInput"))["solarp"];
	hydrop =  JSON.parse(localStorage.getItem("regionBDataInput"))["hydrop"];
	biofuelp = JSON.parse(localStorage.getItem("regionBDataInput"))["biofuelp"];
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUD))/Number(EUB);
	localStorage.setItem("rescfele", res_cf_ele);

}
else if((checkRadioElec != null)&&(checkRadioElec.getAttribute('id')=='elc')&&(checkregion.getAttribute('id')=='regionA')) {
	windp = JSON.parse(localStorage.getItem("regionBDataInput"))["windp"];
	solarp = JSON.parse(localStorage.getItem("regionBDataInput"))["solarp"];
	hydrop =  JSON.parse(localStorage.getItem("regionBDataInput"))["hydrop"];
	biofuelp = JSON.parse(localStorage.getItem("regionBDataInput"))["biofuelp"];
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUA))/Number(EUC);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if((checkRadioElec.getAttribute('id')=='elc')&&(checkregion.getAttribute('id')=='regionB')) {
	windp = JSON.parse(localStorage.getItem("regionBDataInput"))["windp"];
	solarp = JSON.parse(localStorage.getItem("regionBDataInput"))["solarp"];
	hydrop =  JSON.parse(localStorage.getItem("regionBDataInput"))["hydrop"];
	biofuelp = JSON.parse(localStorage.getItem("regionBDataInput"))["biofuelp"];
...
*/
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUD))/Number(EUC);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if((checkRadioElec != null)&&(checkRadioElec.getAttribute('id')=='eld')&&(checkregion.getAttribute('id')=='regionA')) {
	windp = JSON.parse(localStorage.getItem("regionCDataInput"))["windp"];
	solarp = JSON.parse(localStorage.getItem("regionCDataInput"))["solarp"];
	hydrop =  JSON.parse(localStorage.getItem("regionCDataInput"))["hydrop"];
	biofuelp = JSON.parse(localStorage.getItem("regionCDataInput"))["biofuelp"];
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUA))/Number(EUD);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if ((checkRadioElec.getAttribute('id')=='eld')&&(checkregion.getAttribute('id')=='regionB')){
	windp = JSON.parse(localStorage.getItem("regionCDataInput"))["windp"];
	solarp = JSON.parse(localStorage.getItem("regionCDataInput"))["solarp"];
	hydrop =  JSON.parse(localStorage.getItem("regionCDataInput"))["hydrop"];
	biofuelp = JSON.parse(localStorage.getItem("regionCDataInput"))["biofuelp"];
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUB))/Number(EUD);
	localStorage.setItem("rescfele", res_cf_ele);
}
else if((checkRadioElec.getAttribute('id')=='eld')&&(checkregion.getAttribute('id')=='regionC')) {
	windp = JSON.parse(localStorage.getItem("regionCDataInput"))["windp"];
	solarp = JSON.parse(localStorage.getItem("regionCDataInput"))["solarp"];
	hydrop =  JSON.parse(localStorage.getItem("regionCDataInput"))["hydrop"];
	biofuelp = JSON.parse(localStorage.getItem("regionCDataInput"))["biofuelp"];
	...
	var res_cf_ele = (elec_final_cf_ext*Number(EUC))/Number(EUD);
	localStorage.setItem("rescfele", res_cf_ele);
...
if (initial_value_cf_int<titoloCF) {
document.getElementById("percent1").innerHTML = grand_total+ "% above initial value";
}
else {
	document.getElementById("percent1").innerHTML = grand_total+ "% below initial value";
}
...
if((checkRadioPlant != null)&&(checkRadioPlant.getAttribute('id')=='planta')) {
	...
	var plantres_lf_ext = Number(plantres_lf_e)*(Number(RA_LF_Plant)*(1-localStorage.getItem("A_totLFyeld")));
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUB))/Number(EUA);
		localStorage.setItem("reslfplant", res_lf_plant);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
		var plantres_lf_ext = Number(plantres_lf_e)*(Number(RA_LF_Plant)*(1-localStorage.getItem("A_totLFyeld")));
		plantres_lf_ext = Number(plantres_lf_ext);

		var res_lf_plant = (plantres_lf_ext*Number(EUC))/Number(EUA);
		localStorage.setItem("reslfplant", res_lf_plant);
	}
	else {
		var plantres_lf_ext = Number(plantres_lf_e)*(Number(RA_LF_Plant)*(1-localStorage.getItem("A_totLFyeld")));
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUD))/Number(EUA);
		localStorage.setItem("reslfplant", res_lf_plant);
...
//BOTTONE PLANT B
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUA))/Number(EUB);
		localStorage.setItem("reslfplant", res_lf_plant);
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUC))/Number(EUB);
		localStorage.setItem("reslfplant", res_lf_plant);
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUD))/Number(EUB);
		localStorage.setItem("reslfplant", res_lf_plant);
...
//BOTTONE PLANT C
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUA))/Number(EUC);
		localStorage.setItem("reslfplant", res_lf_plant);
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUB))/Number(EUC);
		localStorage.setItem("reslfplant", res_lf_plant);
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUD))/Number(EUC);
		localStorage.setItem("reslfplant", res_lf_plant);
...
//BOTTONE PLANT D
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUA))/Number(EUD);
		localStorage.setItem("reslfplant", res_lf_plant);
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUB))/Number(EUD);
		localStorage.setItem("reslfplant", res_lf_plant);
		...
		var res_lf_plant = (plantres_lf_ext*Number(EUC))/Number(EUD);
		localStorage.setItem("reslfplant", res_lf_plant);
...
if((checkRadioMeat != null)&&(checkRadioMeat.getAttribute('id')=='meata')) {
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUB))/Number(EUA);
		localStorage.setItem("reslfmeat", res_lf_meat);
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUC))/Number(EUA);
		localStorage.setItem("reslfmeat", res_lf_meat);
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUD))/Number(EUA);
		localStorage.setItem("reslfmeat", res_lf_meat);
	}
}
//MEAT BOTTONE B
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUA))/Number(EUB);
		localStorage.setItem("reslfmeat", res_lf_meat);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
		var meatres_lf_ext = Number(meatres_lf_e)*(Number(RB_LF_Meat)*(1-localStorage.getItem("B_totLFyeld")));
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUC))/Number(EUB);
		localStorage.setItem("reslfmeat", res_lf_meat);
	}
	else {
		var meatres_lf_ext = Number(meatres_lf_e)*(Number(RB_LF_Meat)*(1-localStorage.getItem("B_totLFyeld")));
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUD))/Number(EUB);
		localStorage.setItem("reslfmeat", res_lf_meat);
	}
}
//MEAT BOTTONE C
	...
	var res_lf_meat = (meatres_lf_ext*Number(EUA))/Number(EUC);
	localStorage.setItem("reslfmeat", res_lf_meat);
}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var meatres_lf_ext = Number(meatres_lf_e)*(Number(RC_LF_Meat)*(1-localStorage.getItem("C_totLFyeld")));
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUB))/Number(EUC);
		localStorage.setItem("reslfmeat", res_lf_meat);
	}
	else {
		var meatres_lf_ext = Number(meatres_lf_e)*(Number(RC_LF_Meat)*(1-localStorage.getItem("C_totLFyeld")));
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUD))/Number(EUC);
		localStorage.setItem("reslfmeat", res_lf_meat);
	}
}
//BOTTONE MEAT D
	...
	var res_lf_meat = (meatres_lf_ext*Number(EUA))/Number(EUD);
	localStorage.setItem("reslfmeat", res_lf_meat);
}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var meatres_lf_ext = Number(meatres_lf_e)*(Number(RD_LF_Meat)*(1-localStorage.getItem("D_totLFyeld")));
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUB))/Number(EUD);
		localStorage.setItem("reslfmeat", res_lf_meat);
	}
	else {
		var meatres_lf_ext = Number(meatres_lf_e)*(Number(RD_LF_Meat)*(1-localStorage.getItem("D_totLFyeld")));
		...
		var res_lf_meat = (meatres_lf_ext*Number(EUC))/Number(EUD);
		localStorage.setItem("reslfmeat", res_lf_meat);
	}
}
else {
...
if((checkRadioDiary != null)&&(checkRadioDiary.getAttribute('id')=='diarya')) {
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		...
		var res_lf_diary = (diaryres_lf_ext*Number(EUB))/Number(EUA);
		localStorage.setItem("resldiary", res_lf_diary);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
		var diaryres_lf_ext = Number(diaryres_lf_e)*(Number(RA_LF_Diary)*(1-localStorage.getItem("A_totLFyeld")));
		diaryres_lf_ext = Number(diaryres_lf_ext);
...
if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
	...
	localStorage.setItem("A_fossilf", fossil_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
	var fossil_final_lf = (energy_fossil_val)*(Number(RB_LF_Fossil)*0.25)/1000;
	localStorage.setItem("B_fossilf", fossil_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	var fossil_final_lf = (energy_fossil_val)*(Number(RC_D_LF_Fossil)*0.25)/1000;
	localStorage.setItem("C_fossilf", fossil_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	var fossil_final_lf = (energy_fossil_val)*(Number(RC_D_LF_Fossil)*0.25)/1000;
	localStorage.setItem("D_fossilf", fossil_final_lf);
}
else {}
...
if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
	...
	localStorage.setItem("A_biolf", bio_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
	var bio_final_lf = (energy_bio_val)*(Number(RB_LF_Biofuel*0.27))/1000;
	localStorage.setItem("B_biolf", bio_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	var bio_final_lf = (energy_bio_val)*(Number(RC_D_LF_Biofuel*0.27))/1000;
	localStorage.setItem("C_biolf", bio_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	var bio_final_lf = (energy_bio_val)*(Number(RC_D_LF_Biofuel*0.27))/1000;
	localStorage.setItem("D_biolf", bio_final_lf);
}
else{}
...
if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
	...
	localStorage.setItem("A_elelf",elec_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
	...
	var elec_final_lf = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("B_elelf",elec_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	...
	var elec_final_lf = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("C_elelf",elec_final_lf);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	...
	var elec_final_lf = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("D_elelf",elec_final_lf);
	}
else {}
...
//-----------------------------------------------------------------------------------------------
localStorage.setItem("fossillf", fossil_final_lf);
localStorage.setItem("biolf", bio_final_lf);
localStorage.setItem("elelf", elec_final_lf);
...
if (initial_value_lf_int<titoloLF) {
	document.getElementById("percent2").innerHTML =  grand_total+ "% above initial value";
	}
	else {
		document.getElementById("percent2").innerHTML =  grand_total+ "% below initial value";
	}
...
localStorage.setItem("A_fossilwfg", fossil_final_WFgreen );

}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
var fossil_final_WFgreen = (energy_fossil_val)*(Number(RB_WFgreen_Fossil)*0.25)/1000;
localStorage.setItem("B_fossilwfg", fossil_final_WFgreen );
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	var fossil_final_WFgreen = (energy_fossil_val)*(Number(RC_D_WFgreen_Fossil)*0.25)/1000;
	localStorage.setItem("C_fossilwfg", fossil_final_WFgreen );
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	var fossil_final_WFgreen = (energy_fossil_val)*(Number(RC_D_WFgreen_Fossil)*0.25)/1000;
	localStorage.setItem("D_fossilwfg", fossil_final_WFgreen );
} else {}
...
localStorage.setItem("A_biowfg",bio_final_WFgreen);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
var bio_final_WFgreen = (energy_bio_val)*(Number(RB_WFgreen_Biofuel*0.27))/1000;
localStorage.setItem("B_biowfg",bio_final_WFgreen);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	var bio_final_WFgreen = (energy_bio_val)*(Number(RC_D_WFgreen_Biofuel*0.27))/1000;
	localStorage.setItem("C_biowfg",bio_final_WFgreen);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	var bio_final_WFgreen = (energy_bio_val)*(Number(RC_D_WFgreen_Biofuel*0.27))/1000;
	localStorage.setItem("D_biowfg",bio_final_WFgreen);
}
else {}
...
localStorage.setItem("A_elewfg",elec_final_WFgreen );
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
	...
	console.log("ELECTRICITY SUM"+electricity_sum);
	var elec_final_WFgreen = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("B_elewfg",elec_final_WFgreen );
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	...
	console.log("ELECTRICITY SUM"+electricity_sum);
	var elec_final_WFgreen = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("C_elewfg",elec_final_WFgreen );
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	var elec1= Number(windp)*Number(RC_D_WFgreen_Wind);
	var elec2 =Number(solarp)*Number(RC_D_WFgreen_Solar);
	...
	console.log("ELECTRICITY SUM"+electricity_sum);
	var elec_final_WFgreen = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("D_elewfg",elec_final_WFgreen );
}
else{}
...
if (initial_value_wfg_int<titoloWFgreen) {
	document.getElementById("percent3").innerHTML =  grand_total+ "% above initial value";
	}
	else {
		document.getElementById("percent3").innerHTML =  grand_total+ "% below initial value";
	}
...
localStorage.setItem("A_planwfb", plant_WFblue);
localStorage.setItem("A_meatwfb", meat_WFblue);
localStorage.setItem("A_diarywfb", diary_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
	//PLANT:
	//------------------------------------------------------------------------------------------------------------------
	...
	var diary_WFblue = (diaryA)*(diaryC);
	localStorage.setItem("B_planwfb", plant_WFblue);
	localStorage.setItem("B_meatwfb", meat_WFblue);
	localStorage.setItem("B_diarywfb", diary_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	//PLANT:
	//------------------------------------------------------------------------------------------------------------------
	...
	var diary_WFblue = (diaryA)*(diaryC);
	localStorage.setItem("C_planwfb", plant_WFblue);
	localStorage.setItem("C_meatwfb", meat_WFblue);
	localStorage.setItem("C_diarywfb", diary_WFblue);
	...
	localStorage.setItem("D_planwfb", plant_WFblue);
	localStorage.setItem("D_meatwfb", meat_WFblue);
	localStorage.setItem("D_diarywfb", diary_WFblue);
}
else{}

localStorage.setItem("plantwfb", plant_WFblue);
localStorage.setItem("meatwfb", meat_WFblue);
localStorage.setItem("diarywfb", diary_WFblue);
...
localStorage.setItem("A_fossilwfb",fossil_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
var fossil_final_WFblue = (energy_fossil_val)*(Number(RB_WFblue_Fossil)*0.25)/1000;
localStorage.setItem("B_fossilwfb",fossil_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	var fossil_final_WFblue = (energy_fossil_val)*(Number(RC_D_WFblue_Fossil)*0.25)/1000;
	localStorage.setItem("C_fossilwfb",fossil_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	var fossil_final_WFblue = (energy_fossil_val)*(Number(RC_D_WFblue_Fossil)*0.25)/1000;
	localStorage.setItem("D_fossilwfb",fossil_final_WFblue);
} else{}
...
localStorage.setItem("A_biowfb", bio_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
	var bio_final_WFblue = (energy_bio_val)*(Number(RB_WFblue_Biofuel)*0.27)/1000;
	localStorage.setItem("B_biowfb", bio_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	var bio_final_WFblue = (energy_bio_val)*(Number(RC_D_WFblue_Biofuel)*0.27)/1000;
	localStorage.setItem("C_biowfb", bio_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	var bio_final_WFblue = (energy_bio_val)*(Number(RC_D_WFblue_Biofuel)*0.27)/1000;
	localStorage.setItem("D_biowfb", bio_final_WFblue);
} else {}
...
localStorage.setItem("A_elewfb", elec_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
	...
	var elec_final_WFblue = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("B_elewfb", elec_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
	var elec1= Number(windp)*Number(RC_D_WFblue_Wind);
	...
	var elec_final_WFblue = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("C_elewfb", elec_final_WFblue);
}
else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD')) {
	var elec1= Number(windp)*Number(RC_D_WFblue_Wind);
	var elec2 =Number(solarp)*Number(RC_D_WFblue_Solar);
	...
	var elec_final_WFblue = (energy_elec_val)*(electricity_sum)/1000;
	localStorage.setItem("D_elewfb", elec_final_WFblue);
} else {
...
//-----------------------------------------------------------------------------------------------
localStorage.setItem("fossilwfb", fossil_final_WFblue);
localStorage.setItem("biowfb", bio_final_WFblue);
localStorage.setItem("elewfb", elec_final_WFblue);
...
if (initial_value_wfb_int<titoloWFblue) {
	document.getElementById("percent4").innerHTML =  grand_total+ "% above initial value";
}
else {
	document.getElementById("percent4").innerHTML =  grand_total+ "% below initial value";
}
