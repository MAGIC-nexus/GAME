...
var WORLD_plant_cf_FoodY11 = 0.0008; var WORLD_meat_cf_FoodY12 = 0.0129; WORLD_diary_cf_FoodY13 = 0.0064;
var WORLD_plant_lf_FoodX11 = 0.0011; WORLD_meat_lf_FoodX12 = 0.0344; WORLD_diary_lf_FoodX13 = 0.0172;
var WORLD_plant_WFblue_FoodW11 = 0.144; WORLD_meat_WFblue_FoodW12 = 0.18; WORLD_diary_WFblue_FoodW13 = 0.14;
var WORLD_plant_WFgreen_FoodV11 = 0.576; WORLD_meat_WFgreen_FoodV12 = 3.42; WORLD_diary_WFgreen_FoodV13 = 1.30;
...
//			//console.log("MULCHING PARSE: "+Mulching_parse);
		...
		*/
		...
		var dataCF_food_int = Math.round((add1)+(diary_cf));
		...
		//----------------------------------------------------------------------------------------------  	
		var titoloCF = parseFloat((datoCFen_external+dataCF_food_ext)+(datoCFen_internal+dataCF_food_int)*100).toFixed(2);
...
//		//console.log("MULCHING PARSE: "+Mulching_parse);
	...
	//----------------------------------------------------------------------------------------------  	
	var titoloLF = parseFloat((datoLFen_external+dataLF_food_ext)+(datoLFen_internal+dataLF_food_int)*100).toFixed(2);
...
//		//console.log("MULCHING PARSE: "+Mulching_parse);
	...
	//----------------------------------------------------------------------------------------------  	
	var titoloWFgreen = parseFloat((datoWFgreen_en_external+dataWFgreen_food_ext)+(datoWFgreen_en_internal+dataWFgreen_food_int)*100).toFixed(2);
...
//		//console.log("MULCHING PARSE: "+Mulching_parse);
	...
	//----------------------------------------------------------------------------------------------  	
	var titoloWFblue = parseFloat((datoWFblue_en_external+dataWFblue_food_ext)+(datoWFblue_en_internal+dataWFblue_food_int)*100).toFixed(2);
