...
if((checkRadioPlant != null)&&(checkRadioPlant.getAttribute('id')=='planta')) {
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		...
		localStorage.setItem("regionBDataOutput", temp);
...
//BOTTONE PLANT B
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		localStorage.setItem("regionADataOutput", temp);
...
//BOTTONE PLANT C
	...
	console.log("Valore di oggetto C: "+localStorage.getItem("regionCDataOutput"));
	
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RC_CF_Plant)*(1-OutputC["C_totCFyeld"]));
		plantres_cf_ext = Number(plantres_cf_ext);
		console.log("Valore di plantres_cf_e: "+plantres_cf_e+" RC_CF_Plant: "+RC_CF_Plant+" C_totCFyeld: "+OutputC["C_totCFyeld"]+" plantres_cf_ext: "+plantres_cf_ext);
...
dataCF_food_ext = Math.round(dataCF_food_ext);
...
if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuela')) {
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		...
		// login_GlobalVariables.js
		var DataB = JSON.parse(localStorage.getItem("regionBDataOutput"));
		DataA["A_B_bioValue_cf"] = bio_final_cf_ext;
		localStorage.setItem("regionBDataOutput", JSON.stringify(DataB));
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC')) {
...
datoCFen_external = Math.round(datoCFen_external);
...
document.getElementById("valfood_5").innerHTML = valfood11+"% <br><font size='0.5em'>change from initial value</font>";
...
document.getElementById("valenergy_5").innerHTML = valen11+"% <br><font size='0.5em'>change from initial value</font>";
...
dataLF_food_ext = Math.round(dataLF_food_ext);
...
datoLFen_external = Math.round(datoLFen_external);
...
document.getElementById("valfood_6").innerHTML = valfood12+"% <br><font size='0.5em'>change from initial value</font>";
...
document.getElementById("valenergy_6").innerHTML = valen12+"% <br><font size='0.5em'>change from initial value</font>";
...
dataWFgreen_food_ext = Math.round(dataWFgreen_food_ext);
...
datoWFgreen_en_external = Math.round(datoWFgreen_en_external);
...
document.getElementById("valfood_7").innerHTML = valfood13+"% <br><font size='0.5em'>change from initial value</font>";
...
document.getElementById("valenergy_7").innerHTML = valen13+"% <br><font size='0.5em'>change from initial value</font>";
...
dataWFblue_food_ext = Math.round(dataWFblue_food_ext);
...
datoWFblue_en_external = Math.round(datoWFblue_en_external);
...
document.getElementById("valfood_8").innerHTML = valfood14+"% <br><font size='0.5em'>change from initial value</font>";
...
document.getElementById("valenergy_8").innerHTML = valen14+"% <br><font size='0.5em'>change from initial value</font>";
