...
window.addEventListener("load", function () {
	...
	function EU_aggiornabar_sotto_CF() {
		...
		// ------------------- SEZIONE CF --------------------------------
		A_CF_fp_production = Number(regionA["EU_A_sotto_cf"]);
		B_CF_fp_production = Number(regionB["EU_B_sotto_cf"]);
		C_CF_fp_production = Number(regionC["EU_C_sotto_cf"]);
		D_CF_fp_production = Number(regionD["EU_D_sotto_cf"]);
