...
var initial_value_CF_food = 0.003238332; 
var initial_value_LF_food = 0.003459326; 
var initial_value_wfg_food = 1.19415722;
var initial_value_wfb_food = 0.16009438; 
var initial_value_CF_en = 0.062843721771217 ; 
var initial_value_LF_en = 0.00774419419094049 ; 
var initial_value_wfg_en= 5.52412077113194; 
...
//Deficit = Number(parseFloat(Deficit).toFixed(2));
//----------------------------------------------------------------------------------------------------------------
...
fossil_final_cf = parseFloat(fossil_final_cf).toFixed(2);
...
bio_final_cf = parseFloat(bio_final_cf).toFixed(2);
...
var elec_final_cf = parseFloat((energy_elec_val)*(electricity_sum)/1000).toFixed(2);
//console.log("ENERGY ELEC TOTAL CF "+elec_final_cf);
//-----------------------------------------------------------------------------------------------
var datoCFen_internal = Number(elec_final_cf)+Number(bio_final_cf)+Number(fossil_final_cf);
...
if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuelb')) { 
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RB_CF_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_cf_ext = Number(biodue)/1000;
	...
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RC_D_CF_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_cf_ext = Number(biodue)/1000;
	//var bio_final_cf_ext= total_bio_user*(biofuels_parse)*(RA_CF_Biofuel*0.27)/1000;
}
	...
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RA_CF_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_cf_ext = Number(biodue)/1000;
	//var bio_final_cf_ext= total_bio_user*(biofuels_parse)*(RC_D_CF_Biofuel*0.27)/1000;
}
...
fossil_final_lf = parseFloat(fossil_final_lf).toFixed(2);
...
bio_final_lf = parseFloat(bio_final_lf).toFixed(2);
...
var elec_final_lf = parseFloat((energy_elec_val)*(electricity_sum)/1000).toFixed(2);
//console.log("ELECTRICITY LF INT = Energy.I36 (ok) = : "+elec_final_lf);
//-----------------------------------------------------------------------------------------------
var datoLFen_internal = Number(elec_final_lf)+Number(bio_final_lf)+Number(fossil_final_lf);
...
if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuelb')) {
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RB_LF_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_lf_ext = Number(biodue)/1000;
	...
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RC_D_LF_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_lf_ext = Number(biodue)/1000;
	...
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RA_LF_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_lf_ext = Number(biodue)/1000;
	//var bio_final_lf_ext = total_bio_user*(biofuels_parse)*(Number(RA_LF_Biofuel)*0.27)/1000;
...
document.getElementById("GT2").innerHTML = Number(parseFloat(titoloLF).toFixed(1));
...
fossil_final_WFgreen = parseFloat(fossil_final_WFgreen).toFixed(2);
...
bio_final_WFgreen = parseFloat(bio_final_WFgreen).toFixed(2);
...
var elec_final_WFgreen = parseFloat((energy_elec_val)*(electricity_sum)/1000).toFixed(2);

//-----------------------------------------------------------------------------------------------
var datoWFgreen_en_internal = Number(elec_final_WFgreen)+Number(bio_final_WFgreen)+Number(fossil_final_WFgreen);
...
if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuelb')) {
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2);
	var biodue = biouno*(Number(RA_WFgreen_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_WFgreen_ext = Number(biodue)/1000;
	//var bio_final_WFgreen_ext = (total_bio_user*(biofuels_parse)*(Number(RB_WFgreen_Biofuel)*0.27))/1000;
}
else if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuelc')) {
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RB_WFgreen_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_WFgreen_ext = Number(biodue)/1000;
	//var bio_final_WFgreen_ext = (total_bio_user*(biofuels_parse)*(Number(RB_WFgreen_Biofuel)*0.27))/1000;
}
	...
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RC_D_WFgreen_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_WFgreen_ext = Number(biodue)/1000;
...
console.log("ENERGY WFGREEN BIO USER"+total_bio_user);
console.log("ENERGY WFGREEN BIO USER"+biofuels_parse);
console.log("BIOUNO: "+biouno);
console.log("BIODUE: "+biodue);
...
document.getElementById("GT3").innerHTML = Number(parseFloat(titoloWFgreen).toFixed(1));
...
console.log("INIT % TITOLO WFG: "+initial_value_wfg_int);
console.log("RAINFED:"+Rainfed);
console.log("INIT ENERGY WFG: "+initial_value_wfg_en);
...
fossil_final_WFblue = parseFloat(fossil_final_WFblue).toFixed(2);
...
bio_final_WFblue = parseFloat(bio_final_WFblue).toFixed(2);
...
var elec_final_WFblue = parseFloat((energy_elec_val)*(electricity_sum)/1000).toFixed(2);
//console.log("FOSSIL, BIOFUEL ED ELECTRICITY WFBLUE SOPRA: "+fossil_final_WFblue+" "+bio_final_WFblue+" "+elec_final_WFblue);
//-----------------------------------------------------------------------------------------------
var datoWFblue_en_internal = Number(elec_final_WFblue)+Number(bio_final_WFblue)+Number(fossil_final_WFblue);
var WFblue_Energy_Internal=datoWFblue_en_internal;
console.log("FOSSIL, BIOFUEL ED ELECTRICITY WFBLUE SOPRA INTERNAL SUM: "+datoWFblue_en_internal);
...
if((checkRadioBio != null)&&(checkRadioBio.getAttribute('id')=='biofuelb')) {
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RA_WFblue_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_WFblue_ext  = Number(biodue)/1000;
	...
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RB_WFblue_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_WFblue_ext  = Number(biodue)/1000;
	...
	var biouno = total_bio_user*(biofuels_parse);
	biouno = parseFloat(biouno).toFixed(2)/1000;
	var biodue = biouno*(Number(RC_D_WFblue_Biofuel)*0.27);
	biodue = parseFloat(biodue).toFixed(4);
	var bio_final_WFblue_ext  = Number(biodue)/1000;
	//var bio_final_WFblue_ext = total_bio_user*(biofuels_parse)*(Number(RC_D_WFblue_Biofuel)*0.27)/1000;
}
...
console.log("VALORI FOSSIL BIO ELE FINAL WFBLUE SOPRA INT: "+datoWFblue_en_external); 
console.log("VALORI FOSSIL BIO ELE FINAL WFBLUE SOPRA INT: "+elec_final_WFblue_ext+" "+bio_final_WFblue_ext+" "+fossil_final_WFblue_ext); 
