/* *************************************************************************************************************************************************************
	...
	EU-grafici-sopra.JS -> UTILIZZA I VALORI CALCOLATI DA GRAFICI-SECURITY E REGISTRATI NELLE LOCALSTORAGE
	
	QUINDI L'ORDINE DI CARIMENTO DEGLI SCRIPT E': 1) GRAFICI-SECURITY 2) EU-grafici-sopra
...
function EU_aggiornabar_CF() {
	...
	// localStorage registra solo stringhe, quindi anche se il valore che è stato registrato era un intero (1),
	// localStorage restituisce una stringa "1", quindi il controllo è sulla stringa "1" o "0". 
	// Ho già provato usando parseInt(color) ma il controllo Number.isInteger(color) restituiva come risultato false
	
	var color = localStorage.getItem("color");
	if(color=="0") {
		document.getElementById('EU_GT1').innerHTML = 26.0;
		EU_CF_average_rate = 0;
	}
	
	if(EU_CF_average_rate>=1) {
		document.getElementById('EU_percent1').innerHTML = "<font color='red'>"+Math.abs(Math.round(EU_CF_average_rate))+ "% above initial value</font>";
	}
	else if(EU_CF_average_rate<=-1) {
		document.getElementById('EU_percent1').innerHTML = "<font color='green'>"+Math.abs(Math.round(EU_CF_average_rate))+ "% above initial value</font>";
	}
	else {
		document.getElementById('EU_percent1').innerHTML = "<font color='grey'>Equals initial value</font>";
	}
...
function EU_aggiornabar_LF() {
	...
	if(EU_LF_average_rate>=1) {
		document.getElementById('EU_percent2').innerHTML = "<font color='red'>"+Math.abs(Math.round(EU_LF_average_rate))+ "% above initial value</font>";
	}
	else if(EU_LF_average_rate<=-1) {
		document.getElementById('EU_percent2').innerHTML = "<font color='green'>"+Math.abs(Math.round(EU_LF_average_rate))+ "% above initial value</font>";
	}
	else {
		document.getElementById('EU_percent2').innerHTML = "<font color='grey'>Equals initial value</font>";
	}
...
function EU_aggiornabar_WFgreen() {
	...
	if(EU_WFgreen_average_rate>=1) {
		document.getElementById('EU_percent3').innerHTML = "<font color='red'>"+Math.abs(Math.round(EU_WFgreen_average_rate))+ "% above initial value</font>";
	}
	else if(EU_WFgreen_average_rate<=-1) {
		document.getElementById('EU_percent3').innerHTML = "<font color='green'>"+Math.abs(Math.round(EU_WFgreen_average_rate))+ "% above initial value</font>";
	}
	else {
		document.getElementById('EU_percent3').innerHTML = "<font color='grey'>Equals initial value</font>";
	}
...
function EU_aggiornabar_WFblue() {
	...
	if(EU_WFblue_average_rate>=1) {
		document.getElementById('EU_percent4').innerHTML = "<font color='red'>"+Math.abs(Math.round(EU_WFblue_average_rate))+ "% above initial value</font>";
	}
	else if(EU_WFblue_average_rate<=-1) {
		document.getElementById('EU_percent4').innerHTML = "<font color='green'>"+Math.abs(Math.round(EU_WFblue_average_rate))+ "% above initial value</font>";
	}
	else {
		document.getElementById('EU_percent4').innerHTML = "<font color='grey'>Equals initial value</font>";
	}
