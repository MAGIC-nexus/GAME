...
var blu = $primary;
  ...
  //Horizontal Chart
    ...
    function aggiornabarSottouno() {	
    	...
    	if((checkregiong != null)&&(checkregionyg.getAttribute('id')=='regionA')) { 
    	...
    	else if((checkregiong != null)&&(checkregionyg.getAttribute('id')=='regionB')) { 
    	...
    	else if((checkregiong != null)&&(checkregionyg.getAttribute('id')=='regionC')) { 
    	...
    	else if((checkregiong != null)&&(checkregionyg.getAttribute('id')=='regionD')) { 
