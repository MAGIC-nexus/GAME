...
function localLoadData() {
	...
	//---------------------------------------
		...
		if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB') && (DataInput === null)) { 
			document.getElementById("A8_f").value = '7';
			//----------------------------------------------------------------------------------
			document.getElementById("f_D4").value = '2790';
			document.getElementById("f_D5").value = '20';
		...
		if((checkregion != null)&&(checkregion.getAttribute('id')=='regionC') && (DataInput === null)) { 
			document.getElementById("A8_f").value = '7';
			//----------------------------------------------------------------------------------
			document.getElementById("f_D4").value = '2790';
			document.getElementById("f_D5").value = '20';
		...
		if((checkregion != null)&&(checkregion.getAttribute('id')=='regionD') && (DataInput === null)) { 
			document.getElementById("A8_f").value = '7';
			//----------------------------------------------------------------------------------
			document.getElementById("f_D4").value = '2790';
			document.getElementById("f_D5").value = '20';
