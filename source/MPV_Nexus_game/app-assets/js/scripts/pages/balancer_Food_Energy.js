	...
	for(var i=0; i<list.length; i++) {
	  	...
	  	if(button=="button") {
  			...
  			element.classList.add("colorButton");
  			
  			// La variabile globale color si trova dentro load_GlobalVariables.js e serve per indicare ai grafici se l'utente ha modificato qualche input
  			// Se questo succede, allora le percentuali dei grafici possono essere rosse o verdi
  			var action = document.querySelectorAll('.colorButton');
