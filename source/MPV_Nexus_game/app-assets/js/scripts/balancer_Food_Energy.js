	...
	for(var i=0; i<list.length; i++) {
	  	...
	  	if(button=="button") {
	  		...
	  		// la variabile globale color si trova dentro load_GlobalVariables e viene utilizzata dentro grafici-sopra-ok-console.js e grafici-sotto.js
	  		// fino a quando l'utente non esegue nessuna azione, il colore delle percentuali sotto i titoli rimarrà grigio.
	  		document.getElementById("Button"+i).addEventListener("click", function(){color = 1; localStorage.setItem("color", 1);});
	  	}
	}
