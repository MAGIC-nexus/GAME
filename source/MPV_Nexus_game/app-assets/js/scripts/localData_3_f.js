...
function localLoadData() {
	//console.log("Sono dentro Load Data");
	var DataInput={};
	var DataOutput={};
	...
	if(DataInput != null) {
		...
		if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) { 
			...
			document.getElementById("valfood_5").innerHTML = '0.0%';
			document.getElementById("valfood_6").innerHTML = '0.0%';
			document.getElementById("valfood_7").innerHTML = '0.0%';
			document.getElementById("valfood_8").innerHTML = '0.0%';
			
			document.getElementById("valen_5").innerHTML = '0.0%';
			document.getElementById("valen_6").innerHTML = '0.0%';
			document.getElementById("valen_7").innerHTML = '0.0%';
			document.getElementById("valen_8").innerHTML = '0.0%';
			//----------------------------------------------------------------------------------
			LoadPlantValue("W");
			LoadMeatValue("W");
			LoadDiaryValue("W");
			...
			document.getElementById("valenergy_5").innerHTML = '0.0%';
			document.getElementById("valenergy_6").innerHTML = '0.0%';
			document.getElementById("valenergy_7").innerHTML = '0.0%';
			document.getElementById("valenergy_8").innerHTML = '0.0%';
			//----------------------------------------------------------------------------------
			LoadPlantValue("W");
			LoadMeatValue("W");
			LoadDiaryValue("W");
	...
	var plantRadio = document.getElementsByName('checkbuttonsplant');
  	for(var i = 0; i < plantRadio.length; i++) {
    	...
    	if(plantRadio[i].value == plantValue) {
        	...
        	if(plantValue == "W")
        		plantValue="WORLD";
        	document.getElementById("pb").innerHTML="(Source "+plantValue+")";
	...
	var meatRadio = document.getElementsByName('checkbuttonsmeat');
  	for(var i = 0; i < meatRadio.length; i++){
    	...
    	if(meatRadio[i].value == meatValue){
        	...
        	if(meatValue == "W")
        		meatValue="WORLD";
        	document.getElementById("mf").innerHTML="(Source "+meatValue+")";
	...
	var diaryRadio = document.getElementsByName('checkbuttonsdiary');
  	for(var i = 0; i < diaryRadio.length; i++){
    	...
    	if(diaryRadio[i].value == diaryValue){
        	...
        	if(diaryValue == "W")
        		diaryValue="WORLD";
        	document.getElementById("de").innerHTML="(Source "+diaryValue+")";
	...
	var fossilRadio = document.getElementsByName('checkbuttonsfossil');
  	for(var i = 0; i < fossilRadio.length; i++){
    	...
    	if(fossilRadio[i].value == fossilValue){
        	...
        	if(fossilValue == "W")
        		fossilValue="WORLD";
        	document.getElementById("ff").innerHTML="(Source "+fossilValue+")";
	...
	var bioRadio = document.getElementsByName('checkbuttonsbio');
  	for(var i = 0; i < bioRadio.length; i++){
    	...
    	if(bioRadio[i].value == bioValue){
        	...
        	if(bioValue == "W")
        		bioValue="WORLD";
        	document.getElementById("bb").innerHTML="(Source "+bioValue+")";
	...
	var elecRadio = document.getElementsByName('checkbuttonselec');
  	for(var i = 0; i < elecRadio.length; i++){
    	...
    	if(elecRadio[i].value == elecValue){
        	...
        	if(elecValue == "W")
        		elecValue="WORLD";
        	document.getElementById("ec").innerHTML="(Source "+elecValue+")";
...
function SaveGame() {
	document.getElementById("saveicon").classList.add("green");
	document.getElementById("loadicon").classList.remove("green");
	document.getElementById("reseticon").classList.remove("green");
	...
	//document.getElementsByClassName("bx-save")[0].classList.add("green");
}

function LoadGame() {
	document.getElementById("loadicon").classList.add("green");
