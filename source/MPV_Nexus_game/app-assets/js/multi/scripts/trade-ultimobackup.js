...
function Trade_Calc(regiontoA, regionfrA, buttonA, valueA, xA, yA, whoCallA) {
	alert("APPENA APERTO TRADE - DATA FETCH TRADE CALC: "+regiontoA+" "+regionfrA+" "+buttonA+" "+valueA+" "+xA+" "+yA+" "+whoCallA);
	...
	alert("SUBITO DOPO AVER RECUPERATO I PARAMETRI - DATA FETCH TRADE CALC: "+regionfr+" "+regionto+" "+button+" "+value+" "+x+" "+y+" "+whoCall);
	...
	alert("Valore di button: "+button+" Valore di temp: "+temp);
	
	// ----------------------------------------------------------------------------------------------------------------------------------------------------------
	// CREAZIONE DELLA KEY UTILIZZATA DENTRO centralExport: la key creata e quella della centrale devono corrispondere!!!!
	if(button == "plant_based") {
		keycf=regionto+"_"+regionfr+"_"+button.substring(0,5)+"Value_cf";
		keylf=regionto+"_"+regionfr+"_"+button.substring(0,5)+"Value_lf";
		keywfg=regionto+"_"+regionfr+"_"+button.substring(0,5)+"Value_wfg";
		keywfb=regionto+"_"+regionfr+"_"+button.substring(0,5)+"Value_wfb";
	}
	else if(button == "meat_and fish") {
		keycf=regionto+"_"+regionfr+"_"+button.substring(0,4)+"Value_cf";
		keylf=regionto+"_"+regionfr+"_"+button.substring(0,4)+"Value_lf";
		keywfg=regionto+"_"+regionfr+"_"+button.substring(0,4)+"Value_wfg";
		keywfb=regionto+"_"+regionfr+"_"+button.substring(0,4)+"Value_wfb";
	}
	else if(button == "diary_and eggs") {
		keycf=regionto+"_"+regionfr+"_"+button.substring(0,5)+"Value_cf";
		keylf=regionto+"_"+regionfr+"_"+button.substring(0,5)+"Value_lf";
		keywfg=regionto+"_"+regionfr+"_"+button.substring(0,5)+"Value_wfg";
		keywfb=regionto+"_"+regionfr+"_"+button.substring(0,5)+"Value_wfb";
	}
	else if(button == "fossil_fuels") {
		keycf=regionto+"_"+regionfr+"_"+button.substring(0,6)+"Value_cf";
		keylf=regionto+"_"+regionfr+"_"+button.substring(0,6)+"Value_lf";
		keywfg=regionto+"_"+regionfr+"_"+button.substring(0,6)+"Value_wfg";
		keywfb=regionto+"_"+regionfr+"_"+button.substring(0,6)+"Value_wfb";
	}
	else if(button == "biofuels") {
		keycf=regionto+"_"+regionfr+"_"+button.substring(0,3)+"Value_cf";
		keylf=regionto+"_"+regionfr+"_"+button.substring(0,3)+"Value_lf";
		keywfg=regionto+"_"+regionfr+"_"+button.substring(0,3)+"Value_wfg";
		keywfb=regionto+"_"+regionfr+"_"+button.substring(0,3)+"Value_wfb";
	}
	...
	alert("Valore di keycf: "+keycf+" Valore di keylf: "+keylf+" Valore di keywfg: "+keywfg+" Valore di keywfb: "+keywfb);
	
	//Controllo: se sono dentro Yes oppure Test, mi aspetto un numero !=0, se leggo 0, allora impedisco l'aggiornamento della centralExport
	
	if(whoCall === "yes" || whoCall === "test") {
		//console.log("Valore di DataOutput: "+localStorage.getItem("region"+containerRegionAddebt+"DataOutput"));
		if(JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))[keywfg]!=0)
			centralExport[keywfg] = JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))[keywfg];
		if(JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))[keywfb]!=0)
			centralExport[keywfb] = JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))[keywfb];
		if(JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))[keycf]!=0)
			centralExport[keycf] = JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))[keycf];
		if(JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))[keylf]!=0)
			centralExport[keylf] = JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))[keylf];
		alert("Sono dentro whoCall = Test | Yes. Valore di key: "+keyExport+" Valore di CF: "+centralExport[keycf]+" Valore di LF: "+centralExport[keylf]+" Valore di WFG: "+centralExport[keywfg]+" Valore di WFB: "+centralExport[keywfb]);
		}
	else {
		centralExport[keywfg] = 0;
		centralExport[keywfb] = 0;
		centralExport[keycf] = 0;
		centralExport[keylf] = 0;
		alert("Sono dentro whoCall = No. Valore di CF: "+centralExport[keycf]+" Valore di LF: "+centralExport[keylf]+" Valore di WFG: "+centralExport[keywfg]+" Valore di WFB: "+centralExport[keywfb]);
	}
...
////////alert("CONTENUTO DI A_B_PLANTVALUE: "+JSON.parse(localStorage.getItem("region"+containerRegionAddebt+"DataOutput"))["A_B_plantValue_wfg"]);
	...
	//alert("DENTRO FROM B TO A ");
		...
		tempPlant = centralExport["A_B_plantValue_wfg"];
		tempMeat = centralExport["A_B_meatValue_wfg"];
		tempDiary = centralExport["A_B_diaryValue_wfg"];
		...
		tempFossil = centralExport["A_B_fossilValue_wfg"];
		tempBio = centralExport["A_B_bioValue_wfg"];
		tempElec = centralExport["A_B_elecValue_wfg"];
		...
		tempPlant = centralExport["A_B_plantValue_wfb"];
		tempMeat = centralExport["A_B_meatValue_wfb"];
		tempDiary = centralExport["A_B_diaryValue_wfb"];
		...
		tempFossil = centralExport["A_B_fossilValue_wfb"];
		tempBio = centralExport["A_B_bioValue_wfb"];
		tempElec = centralExport["A_B_elecValue_wfb"];
		...
		tempPlant = centralExport["A_B_plantValue_cf"];
		tempMeat = centralExport["A_B_meatValue_cf"];
		tempDiary = centralExport["A_B_diaryValue_cf"];
		...
		tempFossil = centralExport["A_B_fossilValue_cf"];
		tempBio = centralExport["A_B_bioValue_cf"];
		tempElec = centralExport["A_B_elecValue_cf"];
		...
		tempPlant = centralExport["A_B_plantValue_lf"];
		tempMeat = centralExport["A_B_meatValue_lf"];
		tempDiary = centralExport["A_B_diaryValue_lf"];
		...
		tempFossil = centralExport["A_B_fossilValue_lf"];
		tempBio = centralExport["A_B_bioValue_lf"];
		tempElec = centralExport["A_B_elecValue_lf"];
		...
		tempPlant = centralExport["A_C_plantValue_wfg"];
		tempMeat = centralExport["A_C_meatValue_wfg"];
		tempDiary = centralExport["A_C_diaryValue_wfg"];
		...
		tempFossil = centralExport["A_C_fossilValue_wfg"];
		tempBio = centralExport["A_C_bioValue_wfg"];
		tempElec = centralExport["A_C_elecValue_wfg"];
		...
		tempPlant = centralExport["A_C_plantValue_wfb"];
		tempMeat = centralExport["A_C_meatValue_wfb"];
		tempDiary = centralExport["A_C_diaryValue_wfb"];
		...
		tempFossil = centralExport["A_C_fossilValue_wfb"];
		tempBio = centralExport["A_C_bioValue_wfb"];
		tempElec = centralExport["A_C_elecValue_wfb"];
		...
		tempPlant = centralExport["A_C_plantValue_cf"];
		tempMeat = centralExport["A_C_meatValue_cf"];
		tempDiary = centralExport["A_C_diaryValue_cf"];
		...
		tempFossil = centralExport["A_C_fossilValue_cf"];
		tempBio = centralExport["A_C_bioValue_cf"];
		tempElec = centralExport["A_C_elecValue_cf"];
		...
		tempPlant = centralExport["A_C_plantValue_lf"];
		tempMeat = centralExport["A_C_meatValue_lf"];
		tempDiary = centralExport["A_C_diaryValue_lf"];
	  	...
	  	tempFossil = centralExport["A_C_fossilValue_lf"];
		tempBio = centralExport["A_C_bioValue_lf"];
		tempElec = centralExport["A_C_elecValue_lf"];
		...
		tempPlant = centralExport["A_D_plantValue_wfg"];
		tempMeat = centralExport["A_D_meatValue_wfg"];
		tempDiary = centralExport["A_D_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["A_D_fossilValue_wfg"];
		tempBio = centralExport["A_D_bioValue_wfg"];
		tempElec = centralExport["A_D_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["A_D_plantValue_wfb"];
		tempMeat = centralExport["A_D_meatValue_wfb"];
		tempDiary = centralExport["A_D_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["A_D_fossilValue_wfb"];
		tempBio = centralExport["A_D_bioValue_wfb"];
		tempElec = centralExport["A_D_elecValue_wfb"];
		...
		tempPlant = centralExport["A_D_plantValue_cf"];
		tempMeat = centralExport["A_D_meatValue_cf"];
		tempDiary = centralExport["A_D_diaryValue_cf"];
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["A_D_fossilValue_cf"];
		tempBio = centralExport["A_D_bioValue_cf"];
		tempElec = centralExport["A_D_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["A_D_plantValue_lf"];
		tempMeat = centralExport["A_D_meatValue_lf"];
		tempDiary = centralExport["A_D_diaryValue_lf"];
		...
		var sumlf = tempPlant+tempMeat+tempDiary;
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["A_D_fossilValue_lf"];
		tempBio = centralExport["A_D_bioValue_lf"];
		tempElec = centralExport["A_D_elecValue_lf"];
	...
	//alert("SONO IN REGION FROM A TO B");
		...
		//wfg
		//var sumwfg = pwfg+mwfg+dwfg;
		tempPlant = centralExport["B_A_plantValue_wfg"];
		tempMeat = centralExport["B_A_meatValue_wfg"];
		tempDiary = centralExport["B_A_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["B_A_fossilValue_wfg"];
		tempBio = centralExport["B_A_bioValue_wfg"];
		tempElec = centralExport["B_A_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["B_A_plantValue_wfb"];
		tempMeat = centralExport["B_A_meatValue_wfb"];
		tempDiary = centralExport["B_A_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["B_A_fossilValue_wfb"];
		tempBio = centralExport["B_A_bioValue_wfb"];
		tempElec = centralExport["B_A_elecValue_wfb"];
		...
		tempPlant = centralExport["B_A_plantValue_cf"];
		tempMeat = centralExport["B_A_meatValue_cf"];
		tempDiary = centralExport["B_A_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["B_A_fossilValue_cf"];
		tempBio = centralExport["B_A_bioValue_cf"];
		tempElec = centralExport["B_A_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["B_A_plantValue_lf"];
		tempMeat = centralExport["B_A_meatValue_lf"];
		tempDiary = centralExport["B_A_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["B_A_fossilValue_lf"];
		tempBio = centralExport["B_A_bioValue_lf"];
		tempElec = centralExport["B_A_elecValue_lf"];
		...
		//wfg
		//var sumwfg = pwfg+mwfg+dwfg;
		tempPlant = centralExport["B_C_plantValue_wfg"];
		tempMeat = centralExport["B_C_meatValue_wfg"];
		tempDiary = centralExport["B_C_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["B_C_fossilValue_wfg"];
		tempBio = centralExport["B_C_bioValue_wfg"];
		tempElec = centralExport["B_C_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["B_C_plantValue_wfb"];
		tempMeat = centralExport["B_C_meatValue_wfb"];
		tempDiary = centralExport["B_C_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["B_C_fossilValue_wfb"];
		tempBio = centralExport["B_C_bioValue_wfb"];
		tempElec = centralExport["B_C_elecValue_wfb"];
		...
		tempPlant = centralExport["B_C_plantValue_cf"];
		tempMeat = centralExport["B_C_meatValue_cf"];
		tempDiary = centralExport["B_C_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["B_C_fossilValue_cf"];
		tempBio = centralExport["B_C_bioValue_cf"];
		tempElec = centralExport["B_C_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["B_C_plantValue_lf"];
		tempMeat = centralExport["B_C_meatValue_lf"];
		tempDiary = centralExport["B_C_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["B_C_fossilValue_lf"];
		tempBio = centralExport["B_C_bioValue_lf"];
		tempElec = centralExport["B_C_elecValue_lf"];
		...
		//wfg
		//var sumwfg = pwfg+mwfg+dwfg;
		tempPlant = centralExport["B_D_plantValue_wfg"];
		tempMeat = centralExport["B_D_meatValue_wfg"];
		tempDiary = centralExport["B_D_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["B_D_fossilValue_wfg"];
		tempBio = centralExport["B_D_bioValue_wfg"];
		tempElec = centralExport["B_D_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["B_D_plantValue_wfb"];
		tempMeat = centralExport["B_D_meatValue_wfb"];
		tempDiary = centralExport["B_D_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["B_D_fossilValue_wfb"];
		tempBio = centralExport["B_D_bioValue_wfb"];
		tempElec = centralExport["B_D_elecValue_wfb"];
		...
		tempPlant = centralExport["B_D_plantValue_cf"];
		tempMeat = centralExport["B_D_meatValue_cf"];
		tempDiary = centralExport["B_D_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["B_D_fossilValue_cf"];
		tempBio = centralExport["B_D_bioValue_cf"];
		tempElec = centralExport["B_D_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["B_D_plantValue_lf"];
		tempMeat = centralExport["B_D_meatValue_lf"];
		tempDiary = centralExport["B_D_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["B_D_fossilValue_lf"];
		tempBio = centralExport["B_D_bioValue_lf"];
		tempElec = centralExport["B_D_elecValue_lf"];
		...
		tempPlant = centralExport["C_A_plantValue_wfg"];
		tempMeat = centralExport["C_A_meatValue_wfg"];
		tempDiary = centralExport["C_A_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["C_A_fossilValue_wfg"];
		tempBio = centralExport["C_A_bioValue_wfg"];
		tempElec = centralExport["C_A_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["C_A_plantValue_wfb"];
		tempMeat = centralExport["C_A_meatValue_wfb"];
		tempDiary = centralExport["C_A_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["C_A_fossilValue_wfb"];
		tempBio = centralExport["C_A_bioValue_wfb"];
		tempElec = centralExport["C_A_elecValue_wfb"];
		...
		tempPlant = centralExport["C_A_plantValue_cf"];
		tempMeat = centralExport["C_A_meatValue_cf"];
		tempDiary = centralExport["C_A_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["C_A_fossilValue_cf"];
		tempBio = centralExport["C_A_bioValue_cf"];
		tempElec = centralExport["C_A_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["C_A_plantValue_lf"];
		tempMeat = centralExport["C_A_meatValue_lf"];
		tempDiary = centralExport["C_A_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["C_A_fossilValue_lf"];
		tempBio = centralExport["C_A_bioValue_lf"];
		tempElec = centralExport["C_A_elecValue_lf"];
		...
		//wfg
		//var sumwfg = pwfg+mwfg+dwfg;
		tempPlant = centralExport["C_B_plantValue_wfg"];
		tempMeat = centralExport["C_B_meatValue_wfg"];
		tempDiary = centralExport["C_B_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["C_B_fossilValue_wfg"];
		tempBio = centralExport["C_B_bioValue_wfg"];
		tempElec = centralExport["C_B_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["C_B_plantValue_wfb"];
		tempMeat = centralExport["C_B_meatValue_wfb"];
		tempDiary = centralExport["C_B_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["C_B_fossilValue_wfb"];
		tempBio = centralExport["C_B_bioValue_wfb"];
		tempElec = centralExport["C_B_elecValue_wfb"];
		...
		tempPlant = centralExport["C_B_plantValue_cf"];
		tempMeat = centralExport["C_B_meatValue_cf"];
		tempDiary = centralExport["C_B_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["C_B_fossilValue_cf"];
		tempBio = centralExport["C_B_bioValue_cf"];
		tempElec = centralExport["C_B_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["C_B_plantValue_lf"];
		tempMeat = centralExport["C_B_meatValue_lf"];
		tempDiary = centralExport["C_B_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["C_B_fossilValue_lf"];
		tempBio = centralExport["C_B_bioValue_lf"];
		tempElec = centralExport["C_B_elecValue_lf"];
		...
		//wfg
		//var sumwfg = pwfg+mwfg+dwfg;
		tempPlant = centralExport["C_D_plantValue_wfg"];
		tempMeat = centralExport["C_D_meatValue_wfg"];
		tempDiary = centralExport["C_D_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["C_D_fossilValue_wfg"];
		tempBio = centralExport["C_D_bioValue_wfg"];
		tempElec = centralExport["C_D_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["C_D_plantValue_wfb"];
		tempMeat = centralExport["C_D_meatValue_wfb"];
		tempDiary = centralExport["C_D_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["C_D_fossilValue_wfb"];
		tempBio = centralExport["C_D_bioValue_wfb"];
		tempElec = centralExport["C_D_elecValue_wfb"];
		...
		tempPlant = centralExport["C_D_plantValue_cf"];
		tempMeat = centralExport["C_D_meatValue_cf"];
		tempDiary = centralExport["C_D_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["C_D_fossilValue_cf"];
		tempBio = centralExport["C_D_bioValue_cf"];
		tempElec = centralExport["C_D_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["C_D_plantValue_lf"];
		tempMeat = centralExport["C_D_meatValue_lf"];
		tempDiary = centralExport["C_D_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["C_D_fossilValue_lf"];
		tempBio = centralExport["C_D_bioValue_lf"];
		tempElec = centralExport["C_D_elecValue_lf"];
		...
		tempPlant = centralExport["D_A_plantValue_wfg"];
		tempMeat = centralExport["D_A_meatValue_wfg"];
		tempDiary = centralExport["D_A_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["D_A_fossilValue_wfg"];
		tempBio = centralExport["D_A_bioValue_wfg"];
		tempElec = centralExport["D_A_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["D_A_plantValue_wfb"];
		tempMeat = centralExport["D_A_meatValue_wfb"];
		tempDiary = centralExport["D_A_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["D_A_fossilValue_wfb"];
		tempBio = centralExport["D_A_bioValue_wfb"];
		tempElec = centralExport["D_A_elecValue_wfb"];
		...
		tempPlant = centralExport["D_A_plantValue_cf"];
		tempMeat = centralExport["D_A_meatValue_cf"];
		tempDiary = centralExport["D_A_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["D_A_fossilValue_cf"];
		tempBio = centralExport["D_A_bioValue_cf"];
		tempElec = centralExport["D_A_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["D_A_plantValue_lf"];
		tempMeat = centralExport["D_A_meatValue_lf"];
		tempDiary = centralExport["D_A_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["D_A_fossilValue_lf"];
		tempBio = centralExport["D_A_bioValue_lf"];
		tempElec = centralExport["D_A_elecValue_lf"];
		...
		//wfg
		//var sumwfg = pwfg+mwfg+dwfg;
		tempPlant = centralExport["D_B_plantValue_wfg"];
		tempMeat = centralExport["D_B_meatValue_wfg"];
		tempDiary = centralExport["D_B_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["D_B_fossilValue_wfg"];
		tempBio = centralExport["D_B_bioValue_wfg"];
		tempElec = centralExport["D_B_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["D_B_plantValue_wfb"];
		tempMeat = centralExport["D_B_meatValue_wfb"];
		tempDiary = centralExport["D_B_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["D_B_fossilValue_wfb"];
		tempBio = centralExport["D_B_bioValue_wfb"];
		tempElec = centralExport["D_B_elecValue_wfb"];
		...
		tempPlant = centralExport["D_B_plantValue_cf"];
		tempMeat = centralExport["D_B_meatValue_cf"];
		tempDiary = centralExport["D_B_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["D_B_fossilValue_cf"];
		tempBio = centralExport["D_B_bioValue_cf"];
		tempElec = centralExport["D_B_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["D_B_plantValue_lf"];
		tempMeat = centralExport["D_B_meatValue_lf"];
		tempDiary = centralExport["D_B_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["D_B_fossilValue_lf"];
		tempBio = centralExport["D_B_bioValue_lf"];
		tempElec = centralExport["D_B_elecValue_lf"];
		...
		//wfg
		//var sumwfg = pwfg+mwfg+dwfg;
		tempPlant = centralExport["D_C_plantValue_wfg"];
		tempMeat = centralExport["D_C_meatValue_wfg"];
		tempDiary = centralExport["D_C_diaryValue_wfg"];
		...
		//var sumwfgen = fwfg+bwfg+ewfg;
		tempFossil = centralExport["D_C_fossilValue_wfg"];
		tempBio = centralExport["D_C_bioValue_wfg"];
		tempElec = centralExport["D_C_elecValue_wfg"];
		...
		//wfb
		//var sumwfb = pwfb+mwfb+dwfb;
		tempPlant = centralExport["D_C_plantValue_wfb"];
		tempMeat = centralExport["D_C_meatValue_wfb"];
		tempDiary = centralExport["D_C_diaryValue_wfb"];
		...
		//var sumwfben = fwfb+bwfb+ewfb;
		tempFossil = centralExport["D_C_fossilValue_wfb"];
		tempBio = centralExport["D_C_bioValue_wfb"];
		tempElec = centralExport["D_C_elecValue_wfb"];
		...
		tempPlant = centralExport["D_C_plantValue_cf"];
		tempMeat = centralExport["D_C_meatValue_cf"];
		tempDiary = centralExport["D_C_diaryValue_cf"];
		////////alert("Valore di tempPlant: "+tempPlant+" Valore di tempMeat: "+tempMeat);
		...
		//var sumcfen = fcf+bcf+ecf;
		tempFossil = centralExport["D_C_fossilValue_cf"];
		tempBio = centralExport["D_C_bioValue_cf"];
		tempElec = centralExport["D_C_elecValue_cf"];
		...
		//lf
		//var sumlf = plf+mlf+dlf;
		tempPlant = centralExport["D_C_plantValue_lf"];
		tempMeat = centralExport["D_C_meatValue_lf"];
		tempDiary = centralExport["D_C_diaryValue_lf"];
	  	...
	  	//var sumlfen = flf+blf+elf;
	  	tempFossil = centralExport["D_C_fossilValue_lf"];
		tempBio = centralExport["D_C_bioValue_lf"];
		tempElec = centralExport["D_C_elecValue_lf"];
...
if(param_count == 1) {
	RefuseT(regionfr,idp_c,id_riga);
} else {
	//alert("NON SONO PASSATI PARAMETRI E LA FUNZIONE NON è STATA CHIAMATA")
}
	//	FINE WFGREEN //
...
function RefuseT(regionfr,idp_c,id_riga){
    alert("PARAMETRI: "+regionfr+" - "+idp_c+" - "+id_riga+" param: "+param_count);
    
   
    var url = "Refused_multi.jsp?Region="+regionfr+"&Id="+idp_c+"&Ids="+id_riga;
