...
function aggiornabarSottounoOnClick() {
...
function aggiornabarSottodOnClick() {
  		var checkregiong = document.querySelector('input[name="region"]:checked');
		if((checkregiong != null)&&(checkregiong.getAttribute('id')=='regionA')) {
			sustainableLF = 10;
  			physicalLF = 21;
...
function aggiornabarSottotOnClick() {
...
function aggiornabarSottoqOnClick() {
...
function updateDataSotto() {
	//console.log("1 - Sono dentro updateDataSotto()");
	var region = document.querySelector('input[name="region"]:checked').getAttribute('id');
	var letter =  region[region.length-1];
	var Data = JSON.parse(localStorage.getItem(region+"DataOutput"));
	//console.log("Prima di aggiornamento dati - CF: "+Data["EU_"+letter+"_sotto_cf"]+" LF: "+Data["EU_"+letter+"_sotto_cf"]+" WFG: "+Data["EU_"+letter+"_sotto_wfg"]+" WFB: "+Data["EU_"+letter+"_sotto_cf"]);
	
	aggiornabarSottounoOnClick(); aggiornabarSottodOnClick(); aggiornabarSottotOnClick(); aggiornabarSottoqOnClick();
	
	var DataAfter = JSON.parse(localStorage.getItem(region+"DataOutput"));
	//console.log("Dopo di aggiornamento dati - CF: "+DataAfter["EU_"+letter+"_sotto_cf"]+" LF: "+DataAfter["EU_"+letter+"_sotto_cf"]+" WFG: "+DataAfter["EU_"+letter+"_sotto_wfg"]+" WFB: "+DataAfter["EU_"+letter+"_sotto_cf"]);
	//console.log("Fine updateDataSotto()");
}