...
var initial_value_wfb_en = 1.10088961437177 ;
	...
	var regionto = localStorage.getItem("regionto");
	var regionfr = localStorage.getItem("regionfr");
	var button = localStorage.getItem("Button");
	var value = localStorage.getItem("Value");
	var x = localStorage.getItem("X");
	var y = localStorage.getItem("Y");
	var Actual_RegionA_elem = document.getElementById("labregionA");
	var Actual_RegionB_elem = document.getElementById("labregionB");
	var Actual_RegionC_elem = document.getElementById("labregionC");
	var Actual_RegionD_elem = document.getElementById("labregionD");
	var Actual_RegionA_id = Actual_RegionA_elem.id;
	var Actual_RegionB_id = Actual_RegionB_elem.id;
	var Actual_RegionC_id = Actual_RegionC_elem.id;
	var Actual_RegionD_id = Actual_RegionD_elem.id;
	var Actual_RegionA_Class = Actual_RegionA_elem.classList.contains("active");
	var Actual_RegionB_Class = Actual_RegionB_elem.classList.contains("active");
	var Actual_RegionC_Class = Actual_RegionC_elem.classList.contains("active");
	var Actual_RegionD_Class = Actual_RegionD_elem.classList.contains("active");
...
//CALCOLO IL VALORE PER LE SOMME DI FOOD CF INTERNAL:
	...
	//------------------------------------------------------------------------------------------------------------------
    	...
    	//-----------------------------------------------------------------------------------------------
    	//------ CONTROLLO TRADE --------
    	var datiA = 0; var datiB = 0; var datiC = 0; var datiD = 0;
    	
    	if((regionfr == "A" )&&(regionto=="B")) {
    		if((Actual_RegionB_id=="labregionB")&&(Actual_RegionB_Class)) {
    		 
    		datiA=	localStorage.getItem("REGIONA_B_cf"); 
    		
    		} 
    	}
    		else if((regionfr == "A" )&&(regionto=="C")) {
    		if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
    	
    		datiA=	localStorage.getItem("REGIONA_C_cf"); 
    		
    		} 
    		}
    		else if((regionfr == "A" )&&(regionto=="D")) {
    		if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
    		
    		datiA=	localStorage.getItem("REGIONA_D_cf"); 
    	...
    	if((regionfr == "B" )&&(regionto=="A")) {
    		if((Actual_RegionA_id=="labregionA")&&(Actual_RegionA_Class)) {
    		
    		datiB=	localStorage.getItem("REGIONB_A_cf"); 
    		...
    		if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
        		...
        		datiB=	localStorage.getItem("REGIONB_C_cf"); 
    		...
    		if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
        		...
        		datiB=	localStorage.getItem("REGIONB_D_cf"); 
    	...
    	if((regionfr == "C" )&&(regionto=="A")) {
    		...
    		datiC=	localStorage.getItem("REGIONC_A_cf"); 
    		...
    		if((Actual_RegionB_id=="labregionB")&&(Actual_RegionB_Class)) {
        		...
        		datiC=	localStorage.getItem("REGIONC_B_cf"); 
    		...
    		if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
        		...
        		datiC=	localStorage.getItem("REGIONC_D_cf"); 
    	...
    	if((regionfr == "D" )&&(regionto=="A")) {
    		if((Actual_RegionA_id=="labregionA")&&(Actual_RegionA_Class)) {
    		datiD=	localStorage.getItem("REGIOND_A_cf"); 
    	
    		} 
    		}
    	else if((regionfr == "D" )&&(regionto=="B")) {
    		if((Actual_RegionB_id=="labregionB")&&(Actual_RegionB_Class)) {
        		datiD=	localStorage.getItem("REGIOND_B_cf"); 
        		} 
        		}
      	else if((regionfr == "D" )&&(regionto=="C")) {
    		if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
        		datiD=	localStorage.getItem("REGIOND_C_cf"); 
        		} 
        		}
      	else {
    	...
    	var datiaggbar1 = [datiA];
		var datiaggbar2 = [datiB];
		var datiaggbar3 = [datiC];
		var datiaggbar4 = [datiD];
		//////////////////////////////////////////////////////////////////
   		/////////////////////////////////////////////////////////////////
...
if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
	...
	var afoodlf = localStorage.getItem("Afood_lf");
    	...
    	if((regionfr == "A" )&&(regionto=="B")) {
    		...
    		datiA=	localStorage.getItem("REGIONA_B_lf") ; 
    		...
    		datiA=	localStorage.getItem("REGIONA_C_lf") ; 
    		...
    		datiA=	localStorage.getItem("REGIONA_D_lf") ; 
    	...
    	if((regionfr == "B" )&&(regionto=="A")) {
    		...
    		datiB=	localStorage.getItem("REGIONB_A_lf") ; 
    		...
    		if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
        		...
        		datiB=	localStorage.getItem("REGIONB_C_lf") ; 
    		...
    		if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
        		...
        		datiB=	localStorage.getItem("REGIONB_D_lf") ; 
    	...
    	if((regionfr == "C" )&&(regionto=="A")) {
    		...
    		datiC=	localStorage.getItem("REGIONC_A_lf") ; 
    		...
    		if((Actual_RegionB_id=="labregionB")&&(Actual_RegionB_Class)) {
        		...
        		datiC=	localStorage.getItem("REGIONC_B_lf") ; 
    		...
    		if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
        		...
        		datiC=	localStorage.getItem("REGIONC_D_lf") ; 
    	...
    	if((regionfr == "D" )&&(regionto=="A")) {
    		...
    		datiD=	localStorage.getItem("REGIOND_A_lf") ; 
    		...
    		if((Actual_RegionB_id=="labregionB")&&(Actual_RegionB_Class)) {
        		...
        		datiD=	localStorage.getItem("REGIOND_B_lf") ; 
        		
        		} 
        		}
      	else if((regionfr == "D" )&&(regionto=="C")) {
    		if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
        	datiD=	localStorage.getItem("REGIOND_C_lf") ; 
...
//  		console.log("MULCHING PARSE: "+Mulching_parse);
  ...
  //------ CONTROLLO TRADE --------
	...
	if((regionfr == "A" )&&(regionto=="B")) {
		...
		datiA=	localStorage.getItem("REGIONA_B_wfg"); 
		...
		datiA=	localStorage.getItem("REGIONA_C_wfg"); 
		...
		datiA=	localStorage.getItem("REGIONA_D_wfg"); 
	...
	if((regionfr == "B" )&&(regionto=="A")) {
		...
		datiB=	localStorage.getItem("REGIONB_A_wfg"); 
		...
		if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
    		...
    		datiB=	localStorage.getItem("REGIONB_C_wfg"); 
		...
		if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
    		...
    		datiB=	localStorage.getItem("REGIONB_D_wfg"); 
	...
	if((regionfr == "C" )&&(regionto=="A")) {
		...
		datiC=	localStorage.getItem("REGIONC_A_wfg"); 
		...
		if((Actual_RegionB_id=="labregionB")&&(Actual_RegionB_Class)) {
    		...
    		datiC=	localStorage.getItem("REGIONC_B_wfg"); 
		...
		if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
    		...
    		datiC=	localStorage.getItem("REGIONC_D_wfg"); 
	...
	// REGION D
	if((regionfr == "D" )&&(regionto=="A")) {
		if((Actual_RegionD_id=="labregionA")&&(Actual_RegionD_Class)) {
		datiD=	localStorage.getItem("REGIOND_A_wfg"); 
	
		} 
		}
	else if((regionfr == "D" )&&(regionto=="B")) {
		if((Actual_RegionB_id=="labregionB")&&(Actual_RegionB_Class)) {
    		datiD=	localStorage.getItem("REGIOND_B_wfg"); 
    		} 
    		}
  	else if((regionfr == "D" )&&(regionto=="C")) {
		if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
    		datiD=	localStorage.getItem("REGIOND_C_wfg"); 
    		} 
    		}
  	else {
  	...
  	//fine button clicks
  	  ...
  	  //------ CONTROLLO TRADE --------
  		...
  		if((regionfr == "A" )&&(regionto=="B")) {
  			...
  			datiA=	localStorage.getItem("REGIONA_B_wfb"); 
  			...
  			datiA=	localStorage.getItem("REGIONA_C_wfb"); 
  			...
  			datiA=	localStorage.getItem("REGIONA_D_wfb"); 
  		...
  		if((regionfr == "B" )&&(regionto=="A")) {
  			...
  			datiB=	localStorage.getItem("REGIONB_A_wfb"); 
  			...
  			if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
  	    		...
  	    		datiB=	localStorage.getItem("REGIONB_C_wfb"); 
  			...
  			if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
  	    		...
  	    		datiB=	localStorage.getItem("REGIONB_D_wfb"); 
  		...
  		if((regionfr == "C" )&&(regionto=="A")) {
  			...
  			datiC=	localStorage.getItem("REGIONC_A_wfb"); 
  			...
  			if((Actual_RegionB_id=="labregionB")&&(Actual_RegionB_Class)) {
  	    		...
  	    		datiC=	localStorage.getItem("REGIONC_B_wfb"); 
  			...
  			if((Actual_RegionD_id=="labregionD")&&(Actual_RegionD_Class)) {
  	    		...
  	    		datiC=	localStorage.getItem("REGIONC_D_wfb"); 
  		...
  		if((regionfr == "D" )&&(regionto=="A")) {
  			if((Actual_RegionA_id=="labregionA")&&(Actual_RegionA_Class)) {
  			datiD=	localStorage.getItem("REGIOND_A_wfb"); 
  		
  			} 
  			}
  		else if((regionfr == "D" )&&(regionto=="B")) {
  			if((Actual_RegionB_id=="labregionB")&&(Actual_Region_Class)) {
  	    		datiD=	localStorage.getItem("REGIOND_B_wfb"); 
  	    		} 
  	    		}
  	  	else if((regionfr == "D" )&&(regionto=="C")) {
  			if((Actual_RegionC_id=="labregionC")&&(Actual_RegionC_Class)) {
  	    		datiD=	localStorage.getItem("REGIOND_C_wfb"); 
  	    		} 
  	    		}
  	  	else {
