...
//console.log("DIARY TOTAL = Food.K20: "+diary_cf);test
//---------------------------------------------------------------------------------------------------------------------
...
//////////--- BOTTONI DELLE REGIONI, ATTIVAZIONE! NANANANA---///////////
//function displayRadioChoice() {  
    var checkRadio = document.querySelector( 
        'input[name="checkbuttons"]:checked'); 
      
    if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantb')) { 
    	var plantbasedC = RA_CF_Plant*(1-plantbasedB);
   	  
    } 
    else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatb')) { 
    	var meatbasedC = (RA_CF_Meat)*(1-meatbasedB);
   	  
    }
    else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryb')) {
    	var diaryC = (RA_CF_Diary)*(1-(diaryB));
   	  
    }
    
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantc')) { 
    		var plantbasedC = RA_CF_Plant*(1-plantbasedB);
       	  
    	
    	}    
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatc')) {
    		var meatbasedC = (RA_CF_Meat)*(1-meatbasedB);
       	  
    	}
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryc')) {
    		var diaryC = (RA_CF_Diary)*(1-(diaryB));
       	  
    	}

    		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantd')) { 
    			var plantbasedC = RA_CF_Plant*(1-plantbasedB);	
    			
    			}
    		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatd')) {
    			var meatbasedC = (RA_CF_Meat)*(1-meatbasedB);
    			}
    		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryd')) {
    				var diaryC = (RA_CF_Diary)*(1-(diaryB));
    			}
    
    				else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantworld')) { 
    					var plantbasedC = RA_CF_Plant*(1-plantbasedB);	
    					
    				}
    				else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatworld')) {
    					var meatbasedC = (RA_CF_Meat)*(1-meatbasedB);
    				}
    				else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryworld')) {
    					var diaryC = (RA_CF_Diary)*(1-(diaryB));
    				}
     /*ENERGY*/
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='fossilb')) { 

}
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='biofuelb')) {

}
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='elb')) {
...
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='fossilc')) { 

}
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='biofuelc')) {

}
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='elc')) {
...
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='fossild')) { 

}
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='biofueld')) {

}
else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='eld')) {
...
//function displayRadioChoice() {  
    ...
    if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantb')) { 
    	var plantbasedC = RB_LF_Plant*(1-plantbasedB);
    } 
    else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatb')) { 
    	var meatbasedC = (RB_LF_Meat)*(1-meatbasedB);
    }
    else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryb')) {
    	var diaryC = (RB_LF_Diary)*(1-(diaryB));
    }
    
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantc')) { 
    		var plantbasedC = RC_LF_Plant*(1-plantbasedB);
    		
    	}    
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatc')) {
    		var meatbasedC = (RC_LF_Meat)*(1-meatbasedB);
    	}
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryc')) {
    		var diaryC = (RC_LF_Diary)*(1-(diaryB));
    	}

    		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantd')) { 
    			var plantbasedC = RD_LF_Plant*(1-plantbasedB);	
    			
    			}
    		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatd')) {
    			var meatbasedC = (RD_LF_Meat)*(1-meatbasedB);
    			}
    		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryd')) {
    				var diaryC = (RD_LF_Diary)*(1-(diaryB));
    			}
	...
	var elec6 =(PER_B_Fossil)*(RB_LF_Fossil); 	
		...
		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='fossilworld')) { 
			var fossil_final_lf = (energy_fossil_val)*((RA_LF_Fossil)*0.25)/1000;
		}
		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='biofuelworld')) {
			var bio_final_lf = (energy_bio_val)*((RA_LF_Biofuel*0.27))/1000;
		}
		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='elworld')) {
			var elec1= (PER_A_Wind)*(RA_LF_Wind);
			//console.log("SOMMA ELEC1: "+elec1);
			var elec2 =(PER_A_Solar)*(RA_LF_Solar);
			var elec3 =(PER_A_Hydro)*(RA_LF_Hydro);
...
//function displayRadioChoice() {  
    ...
    if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantb')) { 
    	var plantbasedC = RB_WFgreen_Plant*(1-plantbasedB);
    } 
    else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatb')) { 
    	var meatbasedC = (RB_WFgreen_Meat)*(1-meatbasedB);
    }
    else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryb')) {
    	var diaryC = (RB_WFgreen_Diary)*(1-(diaryB));
    }
    
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='plantc')) { 
    	    var plantbasedC = RC_WFgreen_Plant*(1-plantbasedB);
}
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatc')) {
    		var meatbasedC = (RC_WFgreen_Plant)*(1-meatbasedB);
    	}
    	else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryc')) {
    		var diaryC = (RB_WFgreen_Diary)*(1-(diaryB));
    	}
    			...
    			var plantbasedC = RD_WFgreen_Plant*(1-plantbasedB);
    		}    		
    		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='meatd')) {
    			var meatbasedC = (RD_WFgreen_Plant)*(1-meatbasedB);
    			}
    		else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryd')) {
    				var diaryC = (RD_WFgreen_Diary)*(1-(diaryB));
    			}
    					...
    					var meatbasedC = (RA_WFgreen_Plant)*(1-meatbasedB);
    				}
    				else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryworld')) {
    					var diaryC = (RA_WFgreen_Diary)*(1-(diaryB));
    				}
...
//function displayRadioChoice() {  
    var checkRadio = document.querySelector( 
        'input[name="checkbuttons"]:checked'); 
    var TEST = checkRadio.getAttribute('id');
    console.log("ATTRIBUTOO:"+TEST);
    		...
    		var diaryC = (RC_WFblue_Diary)*(1-(diaryB));
    			...
    			var meatbasedC = (RD_WFblue_Plant)*(1-meatbasedB);
    				...
    				var diaryC = (RD_WFblue_Diary)*(1-(diaryB));
    					...
    					var meatbasedC = (RA_WFblue_Plant)*(1-meatbasedB);
    				}
    				else if((checkRadio != null)&&(checkRadio.getAttribute('id')=='diaryworld')) {
    					var diaryC = (RA_WFblue_Diary)*(1-(diaryB));
    				}
