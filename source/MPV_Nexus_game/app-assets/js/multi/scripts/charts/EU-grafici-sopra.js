...
function EU_aggiornabar_CF() {
	...
	if(CF_fp_consum_init_value<EU_CF_average) {
		if(color == 0)
			document.getElementById('EU_percent1').innerHTML = "<font color='grey'>"+Math.abs(Math.round(EU_CF_average_rate))+ "% equals initial value</font>";
		else 
		...
		if(color == 0)
			...
			document.getElementById('EU_percent1').innerHTML = "<font color='green'>"+Math.abs(Math.round(EU_CF_average_rate))+ "% below initial value</font>";
	}
...
function EU_aggiornabar_LF() {
	...
	if(LF_fp_consum_init_value<EU_LF_average){
		if(color == 0)
			document.getElementById('EU_percent2').innerHTML = "<font color='grey'>"+Math.abs(Math.round(EU_LF_average_rate))+ "% equals initial value</font>";
		else 
		...
		if(color == 0)
			...
			document.getElementById('EU_percent2').innerHTML = "<font color='green'>"+Math.abs(Math.round(EU_LF_average_rate))+ "% below initial value</font>";
	}
...
function EU_aggiornabar_WFgreen() {
	...
	if(WFgreen_fp_consum_init_value<EU_WFgreen_average){
		if(color == 0)
			document.getElementById('EU_percent3').innerHTML = "<font color='grey'>"+Math.abs(Math.round(EU_WFgreen_average_rate))+ "% equals initial value</font>";
		else 
		...
		if(color == 0)
			...
			document.getElementById('EU_percent3').innerHTML = "<font color='green'>"+Math.abs(Math.round(EU_WFgreen_average_rate))+ "% below initial value</font>";
	}
...
function EU_aggiornabar_WFblue() {
	...
	if(WFblue_fp_product_init_value<EU_WFblue_average){
		if(color == 0)
			document.getElementById('EU_percent4').innerHTML = "<font color='grey'>"+Math.abs(Math.round(EU_WFblue_average_rate))+ "% equals initial value</font>";
		else 
		...
		if(color == 0)
			...
			document.getElementById('EU_percent4').innerHTML = "<font color='green'>"+Math.abs(Math.round(EU_WFblue_average_rate))+ "% below initial value</font>";
	}
