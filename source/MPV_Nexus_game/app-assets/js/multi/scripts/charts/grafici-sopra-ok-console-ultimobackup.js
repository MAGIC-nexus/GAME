...
var grand_total_2 = grand_total_1-(Number(rounded));
////console.log("GRAND TOTAL ANTE FOOD ENERGY SECONDA DOMMA: "+grand_total_2);
var grand_total_ante = (grand_total_2/Number(rounded));
...
document.getElementById("percent1").innerHTML = "<font color='green'>"+grand_total+ "% below initial value</font>";
		...
		document.getElementById("percent1").innerHTML = "<font color='grey'>0% equals initial value</font>";
...
if (rounded<tit) {
	...
	document.getElementById("percent2").innerHTML = "<font color='green'>"+grand_total+ "% below initial value</font>";
		...
		document.getElementById("percent2").innerHTML = "<font color='grey'>0% equals initial value</font>";
...
if (rounded<tit) {
	...
	document.getElementById("percent3").innerHTML = "<font color='green'>"+grand_total+ "% below initial value</font>";
			...
			document.getElementById("percent3").innerHTML = "<font color='grey'>0% equals initial value</font>";
}
...
if (rounded<tit) {
		...
		document.getElementById("percent4").innerHTML = "<font color='grey'>0% equals initial value</font>";
} else {}
