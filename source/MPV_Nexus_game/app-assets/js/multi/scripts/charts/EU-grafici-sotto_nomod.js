			        ...
			        annotations: [
			          {
			                ...
			                label: {
			                  backgroundColor: "red",
			                  content: "Physical Limit:"+A_physicalLF,
			                  enabled: false
			                },
			                onMouseover: function(e) {
			    				...
			    				element.options.label.content = "Physical Limit:"+A_physicalLF;
			          ...
			          },
			          {
			                ...
			                label: {
			                  ...
			                  content: "Sustainable Limit:"+A_sustainableLF,
			                  enabled: false
			                },
			                onMouseover: function(e) {
			    				var element = this;
			    				...
			    				element.options.label.content = "Sustainable Limit:"+A_sustainableLF;
			    				element.chartInstance.update();
			    				element.chartInstance.chart.canvas.style.cursor = 'pointer';
			    			},
			    			onMouseout: function(e) {
