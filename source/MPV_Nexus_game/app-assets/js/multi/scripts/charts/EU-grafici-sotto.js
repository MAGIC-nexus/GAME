...
function EU_aggiornabar_sotto_CF() {
	...
	// I seguenti valori vengono calcolati e registrati alla fine di ogni funzione dentro grafici-sotto.js
	...
	console.log("CF - Valore di A: "+regionA["EU_A_sotto_cf"]+" B "+regionB["EU_B_sotto_cf"]+" C "+regionC["EU_C_sotto_cf"]+" D "+regionD["EU_D_sotto_cf"]);
	...
	if(EU_average_fp_production_CF<=16) {
		document.getElementById("carboneu").innerHTML="<font color='green'>"+Math.round(EU_average_fp_production_CF, 2)+"%</font>";
	}
	else {
		document.getElementById("carboneu").innerHTML="<font color='red'>"+Math.round(EU_average_fp_production_CF, 2)+"%</font>";
	}
	...
	if (CF_fp_product_init_value<EU_average_fp_production_CF) {
		if(color == 0)
			document.getElementById("EU-percent1_sotto").innerHTML = "<font color='grey'>"+Math.abs(Math.round(CF_fp_product_rate))+ "% equals initial value</font>";
		else 
...
function EU_aggiornabar_sotto_LF() {
	...
	// I seguenti valori vengono calcolati e registrati alla fine di ogni funzione dentro grafici-sotto.js
	A_LF_fp_production = regionA["EU_A_sotto_lf"]; B_LF_fp_production = regionB["EU_B_sotto_lf"];
	C_LF_fp_production = regionC["EU_C_sotto_lf"]; D_LF_fp_production = regionD["EU_D_sotto_lf"];
	
	console.log("LF - Valore di A: "+regionA["EU_A_sotto_lf"]+" B "+regionB["EU_B_sotto_lf"]+" C "+regionC["EU_C_sotto_lf"]+" D "+regionD["EU_D_sotto_lf"]);
	...
	if (LF_fp_product_init_value<EU_average_fp_production_LF) {
		if(color == 0)
			document.getElementById("EU-percent2_sotto").innerHTML = "<font color='grey'>"+Math.abs(Math.round(LF_fp_product_rate))+ "% equals initial value</font>";
		else 
...
function EU_aggiornabar_sotto_WFgreen() {
	...
	*/
	...
	// I seguenti valori vengono calcolati e registrati alla fine di ogni funzione dentro grafici-sotto.js
	A_WFgreen_fp_production = regionA["EU_A_sotto_wfg"]; B_WFgreen_fp_production = regionB["EU_B_sotto_wfg"];
	C_WFgreen_fp_production = regionC["EU_C_sotto_wfg"]; D_WFgreen_fp_production = regionD["EU_D_sotto_wfg"];
	
	console.log("WFG - Valore di A: "+regionA["EU_A_sotto_wfg"]+" B "+regionB["EU_B_sotto_wfg"]+" C "+regionC["EU_C_sotto_wfg"]+" D "+regionD["EU_D_sotto_wfg"]);
	...
	if (WFgreen_fp_product_init_value<EU_average_fp_production_WFgreen) {
		if(color == 0)
			document.getElementById("EU-percent3_sotto").innerHTML = "<font color='grey'>"+Math.abs(Math.round(WFgreen_fp_product_rate))+ "% equals initial value</font>";
		else 
...
function EU_aggiornabar_sotto_WFblue() {
	...
	*/
	...
	// I seguenti valori vengono calcolati e registrati alla fine di ogni funzione dentro grafici-sotto.js
	A_WFblue_fp_production = regionA["EU_A_sotto_wfb"]; B_WFblue_fp_production = regionB["EU_B_sotto_wfb"];
	C_WFblue_fp_production = regionC["EU_C_sotto_wfb"]; D_WFblue_fp_production = regionD["EU_D_sotto_wfb"];
	
	console.log("WFB - Valore di A: "+regionA["EU_A_sotto_wfb"]+" B "+regionB["EU_B_sotto_wfb"]+" C "+regionC["EU_C_sotto_wfb"]+" D "+regionD["EU_D_sotto_wfb"]);
	...
	if (WFblue_fp_product_init_value<EU_average_fp_production_WFblue) {
		if(color == 0)
			document.getElementById("EU-percent4_sotto").innerHTML = "<font color='grey'>"+Math.abs(Math.round(WFblue_fp_product_rate))+ "% equals initial value</font>";
		else 
