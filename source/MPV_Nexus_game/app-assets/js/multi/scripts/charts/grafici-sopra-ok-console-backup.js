...
if((checkRadioPlant != null)&&(checkRadioPlant.getAttribute('id')=='planta')) {
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		...
		//console.log("LocalStorage A_C_plant_cf: "+JSON.parse(localStorage.getItem("regionCDataOutput"))["A_C_plantValue_cf"]);
	}
	else {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RA_CF_Plant)*(1-OutputA["A_totCFyeld"]));
		plantres_cf_ext = Number(plantres_cf_ext);
		...
		//console.log("LocalStorage A_D_plant_cf: "+JSON.parse(localStorage.getItem("regionDDataOutput"))["A_D_plantValue_cf"]);
	}
}
...
//BOTTONE PLANT B
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		//console.log("LocalStorage B_C_plant_cf: "+JSON.parse(localStorage.getItem("regionCDataOutput"))["B_C_plantValue_cf"]);
	}
	else {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RB_CF_Plant)*(1-OutputB["B_totCFyeld"]));
		plantres_cf_ext = Number(plantres_cf_ext);
		...
		//console.log("LocalStorage B_D_plant_cf: "+JSON.parse(localStorage.getItem("regionDDataOutput"))["B_D_plantValue_cf"]);
	}
}
...
//BOTTONE PLANT C
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		console.log("LocalStorage C_A_plant_cf: "+JSON.parse(localStorage.getItem("regionADataOutput"))["C_A_plantValue_cf"]);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RC_CF_Plant)*(1-OutputC["C_totCFyeld"]));
		plantres_cf_ext = Number(plantres_cf_ext);
		...
		//console.log("LocalStorage C_B_plant_cf: "+JSON.parse(localStorage.getItem("regionBDataOutput"))["C_B_plantValue_cf"]);
	}
	else {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RC_CF_Plant)*(1-OutputC["C_totCFyeld"]));
		plantres_cf_ext = Number(plantres_cf_ext);
		...
		//console.log("LocalStorage C_D_plant_cf: "+JSON.parse(localStorage.getItem("regionDDataOutput"))["C_D_plantValue_cf"]);
	}
}
...
//BOTTONE PLANT D
	...
	if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
		...
		//console.log("LocalStorage D_A_plant_cf: "+JSON.parse(localStorage.getItem("regionADataOutput"))["D_A_plantValue_cf"]);
	}
	else if((checkregion != null)&&(checkregion.getAttribute('id')=='regionB')) {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RD_CF_Plant)*(1-OutputD["D_totCFyeld"]));
		plantres_cf_ext = Number(plantres_cf_ext);
		...
		//console.log("LocalStorage D_B_plant_cf: "+JSON.parse(localStorage.getItem("regionBDataOutput"))["D_B_plantValue_cf"]);
	}
	else  {
		var plantres_cf_ext = Number(plantres_cf_e)*(Number(RD_CF_Plant)*(1-OutputD["D_totCFyeld"]));
		plantres_cf_ext = Number(plantres_cf_ext);
		...
		//console.log("LocalStorage D_C_plant_cf: "+JSON.parse(localStorage.getItem("regionCDataOutput"))["D_C_plantValue_cf"]);
	}
}
//BOTTONE PLANT WORLD
else {
...
dataCF_food_ext = Number(dataCF_food_ext);

var dataCF_food_ext_WORLD = (plantworldext+meatworldext+diaryworldext);
var CF_Food_External = dataCF_food_ext;
...
localStorage.setItem("dataCFext", CF_Food_External);
...
datoCFen_external = Number(datoCFen_external);
...
document.getElementById("valfood_1").innerHTML = parseFloat(valfood01).toFixed(4);if(valfood11>0) {

if(valfood11>0) {
	if(color == 0)
		document.getElementById("valfood_5").innerHTML = "<font color='grey'>"+valfood11+"% <br><font size='0.5em'>change from initial value</font></font>";
	else
...
if(valen11>0) {
	if(color == 0)
		document.getElementById("valenergy_5").innerHTML = "<font color='grey'>"+valen11+"% <br><font size='0.5em'>change from initial value</font></font>";
	else
...
if (initial_value_cf_int<titoloCF) {
	if(color == 0)
		document.getElementById("percent1").innerHTML = "<font color='grey'>"+grand_total+ "% equals initial value</font>";
	else 
...
// ===================== AGGIORNAMENTO DATI DA UTILIZZARE IN RELATIONSEU.JS E DENTRO SUSTENAIBLE-LIMITS.JS ================================================
var checkregion = document.querySelector('input[name="region"]:checked');
...
dataLF_food_ext = Number(dataLF_food_ext);
...
datoLFen_external = Number(datoLFen_external);
...
//console.log("LF Food Internal: "+dataLF_food_int+" LF Food External: "+dataLF_food_ext+" LF Energy Internal: "+datoLFen_internal+" LF Energy External: "+datoLFen_external);
...
if (initial_value_lf_int<titoloLF) {
	if(color == 0)
		document.getElementById("percent2").innerHTML = "<font color='grey'>"+grand_total+ "% equals initial value</font>";
	else 
...
dataWFgreen_food_ext = Number(dataWFgreen_food_ext);
...
datoWFgreen_en_external = Number(datoWFgreen_en_external);
...
//----------------------------------------------------------------------------------------------
//console.log("WFG Energy External: "+datoWFgreen_en_external+" WFG Energy Internal: "+datoWFgreen_en_internal+" WFG Food External: "+dataWFgreen_food_ext+" WFG Food Internal: "+dataWFgreen_food_int);
...
if(valfood13>0) {
	if(color == 0)
		document.getElementById("valfood_7").innerHTML = "<font color='grey'>"+valfood13+"% <br><font size='0.5em'>change from initial value</font></font>";
	else
...
if (initial_value_wfg_int<titoloWFgreen) {
	if(color == 0)
		document.getElementById("percent3").innerHTML = "<font color='grey'>"+grand_total+ "% equals initial value</font>";
	else 
...
dataWFblue_food_ext = Number(dataWFblue_food_ext);
...
datoWFblue_en_external = Number(datoWFblue_en_external);
...
if(valfood14>0) {
	if(color == 0)
		document.getElementById("valfood_8").innerHTML = "<font color='grey'>"+valfood14+"% <br><font size='0.5em'>change from initial value</font></font>";
	else
...
if (initial_value_wfb_int<titoloWFblue) {
	if(color == 0)
		document.getElementById("percent4").innerHTML = "<font color='grey'>"+grand_total+ "% equals initial value</font>";
	else 
