	...
	//------------------------------------------------------------------------------------------------------------------
   	...
   	var titoloCF_sotto = parseFloat(Number(dataCF_food_int)+Number(datoCFen_internal)+Number(datiaggbar1)+Number(datiaggbar2)+Number(datiaggbar3)+Number(datiaggbar4)).toFixed(1);
    	...
    	if(localStorage.getItem("GameVersion")=="SP1") { 
			document.getElementById("CFsp1").innerHTML = "<a data-toggle='tooltip' data-placement='bottom' title='Region Carbon footprint of production' id='cftooltip'><img src='icon/cb.png' style='width:24px;' ></a>";
			if(titoloCF_sotto >=16) {
				document.getElementById("CFsp1Value").innerHTML = "<font color='red' style='font-size:1.2rem'>"+titoloCF_sotto+"</font>";
			} 
			else {
				document.getElementById("CFsp1Value").innerHTML = "<font color='#B1FB17' style='font-size:1.2rem'>"+titoloCF_sotto+"</font>";	
			}	
		}
		*/
    	 ...
    	 var grand_total_ante = (prima-initial_grafici_sotto_cf)/initial_grafici_sotto_cf;
			//console.log("WFBLUE PRIMA DEL TITOLO, CALCOLO TITOLO PERCENTUALE "+grand_total_ante);
    	    	...
    	    	if (initial_grafici_sotto_cf<titoloCF_sotto) {
    	    		if(color == 0)
						document.getElementById("percent1_sotto").innerHTML = "<font color='grey'>"+grand_total+ "% equals initial value</font>";
					else 
...
if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) {
	...
	if (initial_grafici_sotto_lf<titoloLF_sotto) {
		if(color == 0)
			document.getElementById("percent2_sotto").innerHTML = "<font color='grey'>"+grand_total+ "% equals initial value</font>";
		else 
  	...
  	/////////////////////////////////////////////////////////////////
  		...
  		//console.log("TITOLO WFGREEN SOTTO: "+Number(dataWFgreen_food_int)+" - "+Number(datoWFgreen_en_internal));
	    	...
	    	if (initial_grafici_sotto_wfg<titoloWFg_sotto) {
	    		if(color == 0)
					document.getElementById("percent3_sotto").innerHTML = "<font color='grey'>"+grand_total+ "% equals initial value</font>";
				else 
...
var physicalWFB = 0;
  	...
  	//fine button clicks
    	...
    	if (initial_grafici_sotto_wfb<titoloWFb_sotto) {
    		if(color == 0)
				document.getElementById("percent4_sotto").innerHTML = "<font color='grey'>"+grand_total+ "% equals initial value</font>";
			else 
