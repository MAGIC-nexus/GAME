...
function targetScore() {
	...
	if(precondition == 1) {	
		var text = "<div class='row' style='margin-let:3%;'>";
		text = text+"<div class='row'><br>";
		text = text+"<div class='row'><h6>Select three (3) key messages for the President of the European Commission.<br> Your score will be multiplied by the number of correct messages (x0, x1, x2, or x3).</h6><br><br><br><br>";
		text = text+"<div class='form-group' style='margin-top:15px;'>";
		text = text+"<input type='checkbox' id='ckx1' class='ckx' name='ckx' value='false'>";
		text = text+"<font style='font-weight:500' id='lckx1'>Applying deficit & drip irrigation & mulching reduces the water footprint significantly</font><hr>";
		text = text+"<input type='checkbox' id='ckx2' class='ckx' name='ckx' value='true'>";
		text = text+"<font style='font-weight:500' id='lckx2'>Less meat (& dairy in second instance) and less food waste reduce the land & water footprint of consumption</font><hr>";
		text = text+"<input type='checkbox' id='ckx3' class='ckx' name='ckx' value='true'>";
		text = text+"<font style='font-weight:500' id='lckx3'>Choosing biofuels increases the land and water footprint</font><hr>";
		text = text+"<input type='checkbox' id='ckx4' class='ckx' name='ckx' value='false'>";
		text = text+"<font style='font-weight:500' id='lckx4'>All EU regions can attain self-sufficiency in food and energy supply, trade is not necessary.</font><hr>";
		text = text+"<input type='checkbox' id='ckx5' class='ckx' name='ckx' value='false'>";
		text = text+"<font style='font-weight:500' id='lckx5'>Whatever electricity mix we have, electrification of the transport sector helps to reduce the carbon footprint a lot</font><hr>";
		text = text+"<input type='checkbox' id='ckx6' class='ckx' name='ckx' value='false'>";
		text = text+"<font style='font-weight:500' id='lckx6'>Switching from fossil to renewable energy has two positive effects: it reduces both the carbon and the water footprint</font><hr>";
		text = text+"<input type='checkbox' id='ckx7' class='ckx' name='ckx' value='true'>";
		text = text+"<font style='font-weight:500' id='lckx7'>Switching from fossil to renewable energy has two positive effects: it reduces the carbon footprint & it increases energy security of the EU </font><hr>";
		text = text+"<input type='checkbox' id='ckx8' class='ckx' name='ckx' value='false'>";
		text = text+"<font style='font-weight:500' id='lckx8'>Saving energy barely reduces the footprints of consumptions</font><hr><br>";
		text = text+"</div><button id='Send-messages' onclick='Multiplier();scrollToTop();'>SUBMIT</button></div></div></div>";
		
		document.getElementById("presidentMessages").innerHTML=text;
	}
	else {
