...
function SaveActualRegion() {
	//alert("Sono dentro SaveActalRegion");
	...
	//console.log("Creo la seguente riga: "+region+"DataOutput");
	//console.log("Contenuto: "+localStorage.getItem(region+"DataOutput"));
	
	DataOutputRegion = JSON.parse(localStorage.getItem(region+"DataOutput"));
	DataOutputRegion["windp"]=windp; DataOutputRegion["solarp"]=solarp; DataOutputRegion["hydrop"]=hydrop;
	DataOutputRegion["biofuelp"]=biofuelp; DataOutputRegion["nuclearp"]=nuclearp; DataOutputRegion["fuelp"]=fuelp;
	localStorage.setItem(region+"DataOutput", JSON.stringify(DataOutputRegion));
}
