...
// I seguenti valori vengono salvati dentro il localStorage locale e usati dentro target-score.js del gioco multiplayer
// E servono per conservare i valori aggiornati di EU security food, energy e carbon footprint of production
var EU_CF_initial_value = 20.3769358104986;
var EU_security_emissions = {
	food:92, energy:70, carbon:(0.8*EU_CF_initial_value)
}
...
function getEuPacksRef() {
	...
	/*
	console.log("Valore di obj: "+EU_packages.split);
	console.log("Valore di regionA: "+regionA);
	console.log("Valore di regionB: "+regionB);
	console.log("Valore di regionC: "+regionC);
	console.log("Valore di regionD: "+regionD);
	*/
