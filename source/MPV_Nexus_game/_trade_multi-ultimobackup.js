...
document.getElementById(nomediv).innerHTML=inviar;
	...
	var inviar = "<span style=\"float:right;\">&nbsp;&nbsp;&nbsp;<a href=\"javascript:void(0);\"  style=\"color:red;text-align:right;font-weight:bold;\" onclick=\"updateData();TrueRequest('"+tipo+"');SendRequest('"+tipo+"','"+valore+"','"+cat+"','"+vreg+"','"+code+"',"+truenumber+");setTimeout(SendDataToDBOnClick, 1000);\"> CLICK & SEND REQUEST TO "+cat+" <i class=\"bx bx-send\" style=\"font-size:11px;\"></i></a></span>";
