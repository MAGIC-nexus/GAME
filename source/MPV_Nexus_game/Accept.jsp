...
for(int i=0;i<A.size();i++){
	ric = (Richieste) A.get(i);
     ...
     lista=lista+"</div>";
     lista=lista+"<div class=\"col-12 px-30 py-75 border-bottom\">";
     lista=lista+"<h6 class=\"media-heading mb-0\"><a href=\"javascript:void(0);\" onclick=\"Trade('"+ric.getFrom()+"','"+ric.getTo()+"','"+ric.getTipo()+"','"+ric.getValore()+"','"+ric.getIdp()+"','"+ric.getId()+"','no');Refuse('"+region+"','"+idp+"','"+ric.getId()+"','no');MyEu('"+region+"','"+idp+"');\">No</a></h6>";
     lista=lista+"</div>";
