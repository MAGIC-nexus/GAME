...
for(int i=0;i<A.size();i++){
   ...
   if(tipo.equals("plant based") || tipo.equals("meat and fish") || tipo.equals("diary and eggs")){
     ...
     lista=lista+"<div class=\"col-12 px-30 py-75 border-bottom\">";
     lista=lista+"<h6 class=\"media-heading text-bold-500 mb-0\"><a href=\"javascript:void(0);\" onclick=\"Trade('"+ric.getFrom()+"','"+ric.getTo()+"','"+ric.getTipo()+"','"+ric.getValore()+"','"+ric.getIdp()+"','"+ric.getId()+"','yes');\" >Yes</a></h6>";
     lista=lista+"</div>";
     lista=lista+"<div class=\"col-12 px-30 py-75 border-bottom\">";
