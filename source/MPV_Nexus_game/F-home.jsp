...
String Ide=(String)session.getAttribute("IdF");
session.setAttribute("IdF", Ide);


String info = op.getUltimateInfoStanze(Integer.parseInt(Ide));
String ids = op.getDinamicInfoStanze(Integer.parseInt(Ide), "Id");
String nome = op.getDinamicInfoStanze(Integer.parseInt(Ide), "Nome");
                        ...
                        <div class="col-xl-4 col-md-6 col-12 dashboard-greetings">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="greeting-text">Last room created</h3>
                                    <p class="mb-0">Show your last room:</p>
                                </div>
