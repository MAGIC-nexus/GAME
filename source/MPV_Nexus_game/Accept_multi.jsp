...
//System.out.println("STANZA ACCEPT_MULTI: "+room);
op.setClassicText(idc, "request", "Status", "Accepted", "Id");
...
/*
if(count>0){
title=title+"<a class=\"nav-link nav-link-label\" href=\"#\" data-toggle=\"dropdown\" style=\"margin-left:10px;\"><b style=\"color:white;\">TRADE </b><b id=\"VREG\" style=\"color:white;\">"+region+"</b>&nbsp;</a>"; 
}else{
title=title+"<a class=\"nav-link nav-link-label\" href=\"#\" data-toggle=\"dropdown\" style=\"margin-left:10px;\"><b style=\"color:white;\">TRADE </b><b id=\"VREG\" style=\"color:white;\">"+region+"</b>&nbsp;</a>"; 	
}
*/
