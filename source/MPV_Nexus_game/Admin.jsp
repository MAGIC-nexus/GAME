                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2"><img src="icon/avatar.jpg" style="width:48px;"> <a href="https://game.magic-nexus.eu/" title="Return to home">Admin Autentication</a></h4>
                                            </div>
                                        </div>
...
<div class="divider">
                                                    <div class="divider-text text-uppercase text-muted"><small> <b>ADMIN AUTHENTICATION</b> </small>
                                                    </div>
                                                </div>
