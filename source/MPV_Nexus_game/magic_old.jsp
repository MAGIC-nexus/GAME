        ...
        <div class="navbar-wrapper">
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                   ...
                   <li class="nav-item d-none d-lg-block"><a data-toggle="tooltip" data-placement="bottom" title="Full Screen" id="" style="font-size:1.2rem;color:#B1FB17;"></a></li>
                   <a class="nav-link nav-link-expand" ><a data-toggle="tooltip" data-placement="bottom" title="Full Screen" id="" style="font-size:1.2rem;color:#B1FB17;"><i class="ficon bx bx-fullscreen"></i></a></a>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group" id="plant-import-keyboard">
                                                    ...
                                                    <label class="btn btn-w active" id="labelPlantW" style="padding:0.1rem 0.7rem;line-height: 2.5rem;">
                                                        <input type="radio"   class="form-control" name="checkbuttonsplant" id="plantworld" value="W" onchange="Source('WORLD','pb')" checked style="padding:0.1rem 0.7rem;line-height: 2.5rem;"> WORLD
                                                    </label>
                                                </div>
                                                </div>
                                            </div>
