...
String linx = op.getDinamicInfoStanze2(Integer.parseInt(Ids), "Ids");
String nome = op.getDinamicInfoStanze2(Integer.parseInt(Ids), "Nome");
String info = op.getInfoStanze(Integer.parseInt(Ids));
tab=tab+"<tr><td>https://game.magic-nexus.eu/Room.jsp?Session="+nome+"!"+linx+"@"+Ids+"&SelectRegionLogin=regionA</td><td>Region A (Austria,  Ireland, Netherlands, Slovakia, Slovenia)</td></tr>";
tab=tab+"<tr><td>https://game.magic-nexus.eu/Room.jsp?Session="+nome+"!"+linx+"@"+Ids+"&SelectRegionLogin=regionB</td><td>Region B (Bulgaria, Estonia, Finland, Hungary, Latvia, Lithuania, Sweden)</td></tr>";
tab=tab+"<tr><td>https://game.magic-nexus.eu/Room.jsp?Session="+nome+"!"+linx+"@"+Ids+"&SelectRegionLogin=regionC</td><td>Region C (Belgium, Cyprus, Czech Republic, Germany, Italy)</td></tr>";
tab=tab+"<tr><td>https://game.magic-nexus.eu/Room.jsp?Session="+nome+"!"+linx+"@"+Ids+"&SelectRegionLogin=regionD</td><td>Region D (France, Poland, Romania, Spain)</td></tr>";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
             ...
             <section class="users-list-wrapper">
                    ...
                    <b>Room :</b> <b style="color:red;"><%=nome %></b> 
                    </div>
