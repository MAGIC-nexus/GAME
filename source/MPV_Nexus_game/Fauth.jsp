...
String esito="";
if(request.getAttribute("operazione")==null){	
}else{
	esito = (String)request.getAttribute("operazione");
}
%>
<head>
...
<body style="background: url('intro/bg_faci.jpg') no-repeat center center; background-size: cover;" id="Bodone" class="horizontal-layout horizontal-menu navbar-sticky 1-column  footer-static  blank-page blank-page" data-open="hover" data-menu="horizontal-menu" data-col="1-column">
    <!-- BEGIN: Content-->
                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2"><img src="icon/avatar.jpg" style="width:48px;"> <a href="https://game.magic-nexus.eu/" title="Return to home">Facilitator Login</a></h4>
                                            </div>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body">
                                            <div align="center"><%=esito %></div>
...
<div class="divider">
                                                    <div class="divider-text text-uppercase text-muted"><small> <b>FACILITATOR AUTHENTICATION</b> </small>
                                                    </div>
                                                </div>
                                                   <form method="post" Id="formy" action="Autentication">
