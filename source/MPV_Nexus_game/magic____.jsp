                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
				      ...
				      <li class="nav-item d-none d-lg-block" style="padding-top:13px;"><a class="nav-link bookmark-star"  id="">
                           <i class="ficon bx bx-reset warning" onclick="ResetGame()"></a></i></a>
                            </li>
				                   <li class="nav-item d-none d-lg-block" style="padding-top:13px;"><a title="Load a saved region configuration, selected by Region button"  class="nav-link bookmark-star"><i class="ficon bx bx-undo warning"  onclick="LoadGame()"></i></a></li>
                        ...
                        <li class="nav-item d-none d-lg-block" style="padding-top:1.7em; margin-left:20px; font-size:1rem;color:#FFFFFF;" >EU TARGETS</li>
                          
                            
                             <li class="nav-item d-none d-lg-block" style="margin-left:30px;padding-top:18px;text-align:left;">
                    ...
                    <tr>
                        ...
                        <td id="cur_blue_D"> </td>
                                          ...
                                          <div style="width:100%;">
													...
													<a  target="popup" href="#" class="form-control btn btn-eu" style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;margin-left:1%;float:left;text-align:center;background-color:#FFCC00;color:white;height:auto;" onclick="window.open('EU-Index.html','popup','width=800,height=600,scrollbars=no,resizable=no'); return false;">EU</a>
                                                </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="boxy">
                                                  <div class="form-group" style="width:90%;margin-left:4%;">
                                                    <label for="emailAddress12">Vegan</label>
                                                      ...
                                                      <input type="text"  class="controllo touchspin form-control balancer" name="C6" id="f_C6" data-bts-postfix="%" value="0" onfocus = "sessionStorage.setItem('f_C6', this.value)" onblur="Controllo('f_C6')" >
                                                  ...
                                                  <div class="form-group" style="width:90%;margin-left:4%;">
                                                    <label for="emailAddress12">Vegetarian</label>
                                                      ...
                                                      <input type="text"  class="controllo touchspin form-control balancer" name="C7" id="f_C7" data-bts-postfix="%" value="6" onfocus = "sessionStorage.setItem('f_C7', this.value)" onblur="Controllo('f_C7')" >
                                                   ...
                                                   <div class="form-group" style="width:90%;margin-left:4%;">
                                                    <label for="emailAddress12">Flexitarian</label>
                                                      ...
                                                      <input type="text"  class="controllo touchspin form-control balancer" name="C8" id="f_C8" value="94" data-bts-postfix="%" onfocus = "sessionStorage.setItem('f_C8', this.value)" onblur="Controllo('f_C8')" >
                                                ...
                                                <div class="form-group input-group"  style="width:90%;margin-left:4%;">
                                                  ...
                                                  <input type="button" value="-" class="button-minus-days" data-field="A8">
                                                    <input type="number"  class="form-control quantity-field" name="A8" id="A8_f" placeholder="7" value="7" min="1" max="7" oninput="";>
                                                  <input type="button" value="+" class="button-plus-days" data-field="A8">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="card">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <input type="text" class="touchspin form-control balancer" data-bts-postfix="%" name="D5" id="f_D5"  value="20" >
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="boxy">
                                              ...
                                              <div class="form-group"  style="width:90%;margin-left:4%;">
                                                    <label>Wind</label>
                                                   <input type="text"  class="touchspin form-control balancer"  id="em_J21" name="J21" data-bts-postfix="%" value="12" onblur="EnergyCheck('em_J21')" onfocus = "sessionStorage.setItem('em_J21', this.value)">
                                                </div>
                                                <div class="form-group"  style="width:90%;margin-left:4%;">
                                                    <label>Solar</label>
                                                   <input type="text"  class="touchspin form-control balancer" id="em_J22" name="J22" data-bts-postfix="%" value="3" onblur="EnergyCheck('em_J22')" onfocus = "sessionStorage.setItem('em_J22', this.value)">
                                                </div>
                                                <div class="form-group"  style="width:90%;margin-left:4%;">
                                                    <label>Hydro</label>
                                                   <input type="text"  class="touchspin form-control balancer" id="em_J23" name="J23" data-bts-postfix="%" value="18" onblur="EnergyCheck('em_J23')" onfocus = "sessionStorage.setItem('em_J23', this.value)">
                                                </div>
                                                 <div class="form-group"  style="width:90%;margin-left:4%;">
                                                    <label>Biofuels</label>
                                                   <input type="text"  class="touchspin form-control balancer" id="em_J24" name="J24" data-bts-postfix="%" value="3" onblur="EnergyCheck('em_J24')" onfocus = "sessionStorage.setItem('em_J24', this.value)">
                                                </div>
                                          ...
                                          <br>
                                            ...
                                            <h6 class="pb-80"><b style="font-style:italic;">Non-renewable</b></h6>
                                             ...
                                             <div class="form-group">
                                                    <label>Nuclear</label>
                                                   <input type="text"  class="touchspin form-control balancer" id="em_J25" name="J25" data-bts-postfix="%" value="4" onblur="EnergyCheck('em_J25')" onfocus = "sessionStorage.setItem('em_J25', this.value)">
                                                </div>
                                                <div class="form-group">
                                                    <label>Fossil</label>
                                                   <input type="text"  class="touchspin form-control balancer" id="em_J26" name="J26" data-bts-postfix="%" value="60" onblur="EnergyCheck('em_J26')" onfocus = "sessionStorage.setItem('em_J26', this.value)">
                                                </div>
