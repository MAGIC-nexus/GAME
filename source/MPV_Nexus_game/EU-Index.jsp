                    ...
                    <ul class="nav navbar-nav float-right d-flex align-items-center">
                    	<div id="user-status"><span style="color:#fff"></span></div>
                   		<li id="eutargets" class="nav-item d-none d-lg-block" style="padding-top:1.7em; margin-left:20px; font-size:1rem;color:#FFFFFF;" >EU TARGETS</li>
                             ...
                             <li id="euf" class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:20px;">
                             <a data-toggle="tooltip" data-placement="left"  style="font-size:1.2rem;color:#E55B3C;"
                             title="Target value &ge;95% " id="">
                             <span id="eufood"></span>
                             </a>
                             </li>

                              <li id="euet" class="nav-item d-none d-lg-block" style="margin-left:15px;padding-top:18px;">
                              <a data-toggle="tooltip" data-placement="left" title="% of energy supply met by energy in the EU" id="">
                   		...
                   		<li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                        	<div class="user-nav d-lg-flex d-none"><span class="user-name">Nexus</span><span class="user-status" id="nomeplayer"></span></div>								<span><img class="round" src="icon/avatar.jpg" alt="avatar" height="40" width="40"></span></a>
...
will be multiplied by the number of correct messages (x0, x1, x2, or x3).</h6><br><br><br>
                        ...
                        <div class="form-group" style="margin-top:15px;">
                        	<input type="checkbox" id="ckx0" class="ckx" name="ckx">
							...
							<input type="checkbox" id="ckx1" class="ckx" name="ckx">
                            ...
                            <input type="checkbox" id="ckx4" class="ckx" name="ckx">
							...
							<input type="checkbox" id="ckx5" class="ckx" name="ckx">
							...
							<input type="checkbox" id="ckx6" class="ckx" name="ckx">
							...
							<input type="checkbox" id="ckx7" class="ckx" name="ckx">
