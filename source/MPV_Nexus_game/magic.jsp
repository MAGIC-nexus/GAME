...
<body onLoad="myHeight(); MyTrade('<%=region %>','<%=code %>');MyEu('<%=region %>','<%=code %>'); VRequest('<%=region %>','<%=code %>','Mf');VRequest('<%=region %>','<%=code %>','Pb');VRequest('<%=region %>','<%=code %>','De');VRequest('<%=region %>','<%=code %>','Ff');VRequest('<%=region %>','<%=code %>','Bf');VRequest('<%=region %>','<%=code %>','Ec');" class="horizontal-layout horizontal-menu navbar-sticky 2-columns   footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
    	...
    	<div class="modal-dialog">
      		...
      		<div class="modal-content">
        		<div class="modal-header">
          			...
          			<h4 class="modal-title" id="modal-headertext"></h4>
        		</div>
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
				       ...
				       <li class="nav-item d-none d-lg-block" style="padding-top:13px;"><a class="nav-link bookmark-star"  title="Restore default data configuration"   href="javascript:void(0);"> <i class="ficon bx bx-reset warning" id="reseticon" onclick="ResetGame()"></i></a></li>
				       <li class="nav-item d-none d-lg-block" style="padding-top:13px;"><a class="nav-link bookmark-star" title="Load a saved region configuration, selected by Region button"  ><i class="ficon bx bx-undo warning" id="loadicon" onclick="LoadGame()"></i></a></li>
                      ...
                      <li id="eutargets" class="nav-item d-none d-lg-block" style="padding-top:1.7em; margin-left:20px; font-size:1rem;color:#FFFFFF;" >EU TARGETS</li>
                             ...
                             <li id="foodup" class="nav-item d-none d-lg-block" style="margin-left:30px;padding-top:18px;text-align:left;">
                             ...
                             <li class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:20px;" id="euf">
                             ...
                             <li class="nav-item d-none d-lg-block" style="margin-left:15px;padding-top:18px;" id="euet">
                             <a data-toggle="tooltip" data-placement="bottom" title="% of energy supply met by energy in the EU">
                             <img src="icon/es.png" style="width:24px;"  >
                             </a>
                             </li>                             </li>

                             <li id="securitysup" class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:20px;">
                             <a data-toggle="tooltip" data-placement="bottom" style="font-size:1.2rem;color:#E55B3C;"
                             ...
                             <li id="carbonsupicon" class="nav-item d-none d-lg-block" style="margin-left:15px;padding-top:18px;">
                             <a data-toggle="tooltip" data-placement="bottom"
                             title="EU-average carbon footprint of production" id="carbonicon" style="font-size:1.2rem;color:#E55B3C;">
                             <img src="icon/cb.png" style="width:24px;">
                             </a>
                             </li>

                             <li id="carbonsup" class="nav-item d-none d-lg-block" style="margin-left:10px;padding-top:20px;">
                             <a data-toggle="tooltip" data-placement="bottom"
						...
						<li class="dropdown dropdown-notification nav-item d-none d-lg-block" id="tradecenter"></li>
						 <a data-toggle="tooltip" data-placement="bottom" title="Notification Center" id="">
                    ...
                    <div id="user-status"><span style="color:#fff"></span></div>
                             ...
                             <li class="nav-item d-none d-lg-block" style="text-align:right;padding-right:15px;padding-top:8px;" id="CFsp1">
                             	<a data-toggle="tooltip" data-placement="bottom" title="Carbon Footprint of Production" id="" style="font-size:1.2rem;color:#E55B3C;"></a>
                             </li>
							 <li class="nav-item d-none d-lg-block" style="text-align:right;padding-right:15px;padding-top:8px;" id="CFsp1Value">
							 	<a data-toggle="tooltip" data-placement="bottom" title="Target value &le;16" id="" style="font-size:1.2rem;color:#E55B3C;"></a>
							 </li>

                              <li class="nav-item d-none d-lg-block" style="padding-top:8px;text-align:right;padding-right:5px;" id="lands">
                             ...
                             <li class="nav-item d-none d-lg-block" style="text-align:right;padding-right:15px;padding-top:8px;" id="landsic">
                             <a data-toggle="tooltip" data-placement="bottom" title="Target value &le;0" id="land_tooltip" style="font-size:1.2rem;color:#E55B3C;">
                              <span id="Land_limits"></span></a>
                               ...
                               <li class="nav-item d-none d-lg-block" style="padding-top:8px;text-align:right;padding-right:5px;" id="greens">
                             ...
                             <li class="nav-item d-none d-lg-block" style="text-align:right;padding-right:15px;padding-top:8px;" id="greensic">
                             ...
                             <a data-toggle="tooltip" data-placement="bottom" title="Target value &le;0" id="green_tooltip" style="font-size:1.2rem;color:#E55B3C;">
                              <span id="GW_limits"></span></a>
                               ...
                               <li class="nav-item d-none d-lg-block" style="padding-top:8px;text-align:right;padding-right:5px;" id="blues">
                             ...
                             <li class="nav-item d-none d-lg-block" style="text-align:right;padding-right:20px;padding-top:8px;" id="bluesic">
                                ...
                                <div class="card-body">
                                    <!-- accordion start -->
                                     ...
                                     Play now: make your choices!
										...
										<!-- <div id="datadownload" style="display: inline-block;"></div> -->
                ...
                <h3>TOTAL SCORE: </h3><br><h3 id="total_score"></h3>
                                          ...
                                          <div style="width:100%;">
												...
												<%}%>
                                                    ...
                                                    <label id="labregionA" class="btn btn-a regionA nonattivo" style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;float:left; visibility:hidden;">
                                                        <input type="radio" class="form-control" name="region" id="regionA" style="padding:0.1rem 0.7rem;line-height: 2.5rem;height:auto;" onchange=" localSaveData(); localLoadData(); disableButtons('A'); MyTrade('A','<%=code %>');MyEu('A','<%=code %>'); VRequest('A','<%=code %>','Mf');VRequest('A','<%=code %>','Pb');VRequest('A','<%=code %>','De');VRequest('A','<%=code %>','Ff');VRequest('A','<%=code %>','Bf');VRequest('A','<%=code %>','Ec');" checked> A
                                                    </label>
                                                    <label id="labregionB" class="btn btn-b regionB nonattivo " style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;margin-left:1%;float:left; visibility:hidden; ">
                                                        <input type="radio" class="form-control" name="region" id="regionB" style="padding:0.1rem 0.7rem;line-height: 2.5rem;height:auto;" onchange=" localSaveData(); localLoadData(); disableButtons('B'); MyTrade('B','<%=code %>');MyEu('B','<%=code %>'); VRequest('B','<%=code %>','Mf');VRequest('B','<%=code %>','Pb');VRequest('B','<%=code %>','De');VRequest('B','<%=code %>','Ff');VRequest('B','<%=code %>','Bf');VRequest('B','<%=code %>','Ec');" >B
                                                    </label>
                                                    <label id="labregionC" class="btn btn-c regionC nonattivo" style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;margin-left:1%;float:left; visibility:hidden; ">
                                                        <input type="radio" class="form-control" name="region" id="regionC" style="padding:0.1rem 0.7rem;line-height: 2.5rem;height:auto;" onchange="  localSaveData(); localLoadData(); disableButtons('C'); MyTrade('C','<%=code %>');MyEu('C','<%=code %>'); VRequest('C','<%=code %>','Mf');VRequest('C','<%=code %>','Pb');VRequest('C','<%=code %>','De');VRequest('C','<%=code %>','Ff');VRequest('C','<%=code %>','Bf');VRequest('C','<%=code %>','Ec');">C
                                                    </label>
                                                    <label id="labregionD" class="btn btn-d regionD nonattivo"  style="padding:0.1rem 0.7rem;line-height: 2.5rem;width:19%;margin-left:1%;float:left; visibility:hidden;">
                                                        <input type="radio" class="form-control" name="region" id="regionD" style="padding:0.1rem 0.7rem;line-height: 2.5rem;height:auto;" onchange="  localSaveData(); localLoadData(); disableButtons('D'); MyTrade('D','<%=code %>');MyEu('D','<%=code %>'); VRequest('D','<%=code %>','Mf');VRequest('D','<%=code %>','Pb');VRequest('D','<%=code %>','De');VRequest('D','<%=code %>','Ff');VRequest('D','<%=code %>','Bf');VRequest('D','<%=code %>','Ec');">D
                                                    </label>
                                    ...
                                    <div class="card-body pl-0">
                                       ...
                                       <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" value="0" id="E30" name="E30" value="100" data-bts-postfix="%" onchange="Quest('plant based',this.value,document.getElementById('pb').innerHTML,'<%=code%>','<%=version%>');">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" value="0"  id="E31" name="E31" value="100" data-bts-postfix="%" onchange="Quest('meat and fish',this.value,document.getElementById('mf').innerHTML,'<%=code%>','<%=version%>');">
                                            ...
                                            <div class="col-sm-6">
                                             ...
                                             <div class="col-12">
                                             <h6 class="py-50">Category: Dairy & Eggs</h6>
                                            </div>
                                          <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label  style="font-size:11px;">% food in this category imported <b id="de">(Source World)</b></label>
                                                   <input type="text"  class="touchspin form-control color" value="0"  id="E32" name="E32" value="100" data-bts-postfix="%" onchange="Quest('diary and eggs',this.value,document.getElementById('de').innerHTML,'<%=code%>','<%=version%>');">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" id="L30" name="L30" value="74" data-bts-postfix="%" onchange="Quest('fossil fuels',this.value,document.getElementById('ff').innerHTML,'<%=code%>','<%=version%>');">
                                          ...
                                          <div class="col-sm-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" id="L31" name="L31" value="0" data-bts-postfix="%" onchange="Quest('biofuels',this.value,document.getElementById('bb').innerHTML,'<%=code%>','<%=version%>');">
                                          ...
                                          <div class="col-sm-6">
                                                <div class="form-group" id="">
                                                   ...
                                                   <input type="text"  class="touchspin form-control color" id="L32" name="L32" value="0" data-bts-postfix="%"  onchange="Quest('electricity',this.value,document.getElementById('ec').innerHTML);">
                            ...
                            <div id="collapse8" role="tabpanel" aria-labelledby="headingCollapse8" class="collapse">
                                <div class="card-content">
									...
									<div class="eff" style="width:100%;color:#008000;"><i class="bx bx-subdirectory-right"></i> EFFICIENCY OF CONSUMED FOOD <small></small></div>
                                                ...
                                                <span class="align-middle text-muted" style="font-weight:600;">Carbon <br>(kg CO2/kcal) </span>
                                                </div>
												</div>
		                                       ...
		                                       <div class="col-sm celle" >
                                                ...
                                                <span class="align-middle text-muted" style="font-weight:600;">Land <br>(m2/kcal)</span>
                                                </div>
		                                       </div>
		                                       ...
		                                       <div class="col-sm celle" >
                                                ...
                                                <span class="align-middle text-muted" style="font-weight:600;">Green Water <br>(l/kcal)</span>
                                                </div>
		                                      </div>
                                                ...
                                                <span class="align-middle text-muted" style="font-weight:600;">Blue Water <br>(l/kcal)</span>
                                                </div>
		                                       </div>
	...
	<div class="col-sm celle" >
		                                        <div class="user-analytics">
                                                <img class="mr-25 align-middle" src="icon/cb.png" style="width:1.5rem;" />
                                                <span class="align-middle text-muted" style="font-weight:600;">Carbon <br>(kg CO2/MJ)</span>
                                                </div>
												</div>
		                                       ...
		                                       <div class="col-sm celle" >
		                                        <div class="user-analytics">
                                                <img class="mr-25 align-middle" src="icon/la.png" style="width:1.5rem;" />
                                                <span class="align-middle text-muted" style="font-weight:600;">Land <br>(m2/MJ)</span>
                                                </div>
		                                       </div>
		                                       ...
		                                       <div class="col-sm celle" >
		                                        <div class="user-analytics">
                                                <img class="mr-25 align-middle" src="icon/gww.png" style="width:1.5rem;" />
                                                <span class="align-middle text-muted" style="font-weight:600;">Green Water <br>(l/MJ)</span>
                                                </div>
		                                      </div>
		                                        ...
		                                        <div class="user-analytics">
                                                <img class="mr-25 align-middle" src="icon/bw.webp" style="width:1.5rem;" />
                                                <span class="align-middle text-muted" style="font-weight:600;">Blue Water <br>(l/MJ)</span>
                                                </div>
		                                       </div>
    ...
    <input type="hidden" id="external_cf" value=""></input>
  	...
  	<script src="app-assets/js/scripts/load_GlobalVariables.js"></script>
   	<!-- BEGIN: Vendor JS-->
    ...
    <!--  <script src="app-assets/vendors/js/charts/chart.min.js"></script> -->
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.6.0/Chart.min.js"></script>
        	        	<script src="app-assets/js/scripts/trade-script.js"></script>

        <script src="app-assets/js/scripts/charts/grafici-sopra-ok-console.js"></script><!-- PRIMI 4 GRAFICI A BARRE -->
       	<script src="app-assets/js/scripts/charts/grafici-security.js"></script><!-- 2 GRAFICI SECURITY -->
       	<script src="app-assets/js/scripts/charts/grafici-sotto.js"></script><!-- 4 GRAFICI SOTTO CON LIMITI -->
       	<script src="app-assets/js/scripts/charts/EU-grafici-security-perc.js"></script><!-- 4 GRAFICI SOTTO CON LIMITI -->
       	<script src="app-assets/js/scripts/charts/EU-grafici-sotto-carbon-emission.js"></script><!-- 4 GRAFICI SOTTO CON LIMITI -->



       	<script src="app-assets/js/scripts/charts/grafici-pie-e-mix-energy.js"></script>
       	<!-- TORTA FOOD E ENERGY MIX -->
  	<!-- SCRIPT LOCAL STORAGE -->
 		<script src="app-assets/js/scripts/disableButtons.js"></script>
 		<script src="app-assets/js/scripts/localData_3_f.js"></script>
 		<script src="app-assets/js/scripts/penalityok.js"></script>
 		        	<script src="app-assets/js/scripts/trade.js"></script>

 		<script src="app-assets/js/scripts/sustanaible-limits.js"></script>
 		<script src="app-assets/js/scripts/result-balancer.js"></script>
 		 		<script src="app-assets/js/scripts/resetall.js"></script>
 		 		 		 		<script src="app-assets/js/scripts/freeze.js"></script>
 	...
 	<!--  BALANCER -->
  		<script src="app-assets/js/scripts/balancer_Food_Energy.js"></script>
