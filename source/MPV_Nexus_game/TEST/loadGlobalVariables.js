...
function loadGlobalVariables() {
	...
	document.getElementById("nomeplayer").innerHTML = "Benvenuto, "+player;
	...
	if(Version=="SP1") {
	 ...
	 if (Version=="SP2") {
		...
		if((checkregion != null)&&(checkregion.getAttribute('id')=='regionA')) { 
			document.getElementById("regionA").checked;
	...
	//---------------------------------------
			...
			document.getElementById("regionB").checked;
		...
		//---------------------------------
			...
			document.getElementById("regionC").checked;
			...
			document.getElementById("regionD").checked;
