...
boolean esito = false;String visual="";
if(request.getParameter("Action")==null){	
	...
	int Id = op.getID("Id", "fac_pending");
	esito = op.newPFac(nome, surname, email, country, orga, Id);
	if(esito==true){
		visual="<b style=\"color:green;font-size:20px;\">Request sent</b>";
		  String mitt = "game.nexus@eligesoft.com";
	      String dest =  email;
	      String oggetto ="New Request";
	      String oggetto2="Request sent";
	      String testo="<html><head></head><body><img src=\"cid:123logo\" /><br><br>New Request to Nexus Game from:<br>"+nome+" "+surname+"<br>Email: "+email+"<br>Organization: "+orga+"<br>Country: "+country+"<br>";
	      testo=testo+"<br><br>Thank you.</body></html>";
	      String testo2="<html><head></head><body><img src=\"cid:123logo\" /><br><br>";
	      testo2=testo2+"Thank you for your facilitator access credentials request. <br>You'll receive username and password as soon as possible.<br><br>Thank you.";
	      testo2=testo2+"</body></html>";
	      MailUtility.sendMail(dest, mitt, oggetto, testo);
	      MailUtility.sendMail(email, mitt, oggetto2, testo2);
	}else{
		visual="Request not sent";
	}
}
%>
<head>
...
<body style="background: url('intro/bg_admin.jpg') no-repeat center center; background-size: cover;" id="Bodone" class="horizontal-layout horizontal-menu navbar-sticky 1-column  footer-static  blank-page blank-page" data-open="hover" data-menu="horizontal-menu" data-col="1-column">
    <!-- BEGIN: Content-->
                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2"><img src="icon/avatar.jpg" style="width:48px;"> <a href="Room.jsp" title="Return to home">Request new account</a></h4>
                                            </div>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body">
                                            <div align="center"><b><%=visual %></b></div>
                                             <div class="d-flex flex-md-row flex-column justify-content-around">
                                              ...
                                              <div class="divider">
                                                    <div class="divider-text text-uppercase text-muted"><small> <b>Request new account</b> </small>
                                                    </div>
                                                </div>
                                                   <form method="post" Id="formy" action="Freq.jsp">
                                                    <div class="form-group mb-50">
                                                       ...
                                                       <div class="form-group mb-50">
                                                        <label class="text-bold-600" for="exampleInputEmail1">Surname</label>
                                                    ...
                                                    <div class="form-group mb-50">
                                                        <label class="text-bold-600" for="exampleInputEmail1">Organization</label>
                                                        <input type="text" class="form-control" id="Organization" placeholder="Organization" name="Organization" required>
                                                    </div>
                                                    
                                                    <div class="form-group mb-50">
                                                        <label class="text-bold-600" for="exampleInputEmail1">Country/Town of Organization</label>
                                                    ...
                                                    <button type="submit" class="btn btn-primary glow w-100 position-relative" style="margin-top:20px;" id="LoginButton" >Send Request<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
   ...
   <!-- BEGIN: Vendor JS-->
    ...
    function Vis(valore){
    	if(valore =='SP1'){
    		...
    		document.getElementById("Contenuto").innerHTML = "<b style='color:red;'>Single Player Level 2</b><br><br>Single Player Level 2 focuses on the challenge to achieve food and energy security for the EU as a whole, while also achieving sustainability targets in each of the member states (i.e. corresponding to one of the four EU regionâ€™s in the game).<br><br>The player controls all four EU regions and has full flexibility in changing practices and closing trade agreements.<br><br>This version is recommended for anyone with more experience regarding the water-land-carbon-food-energy nexus, and people who have mastered Single Player Level 1."; 
