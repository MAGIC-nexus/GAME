...
for(int i=0;i<A.size();i++){
	ric = (Richieste) A.get(i);
     ...
     lista=lista+"<div class=\"avatar bg-primary bg-lighten-5 mr-1 m-0 p-25\"><span class=\"avatar-content text-primary font-medium-2\"><i class=\"bx bx-log-in-circle\"></i></span></div>";
     }else{
     lista=lista+"<div class=\"avatar bg-primary bg-lighten-5 mr-1 m-0 p-25\"><span class=\"avatar-content text-primary font-medium-2\"><i class=\"bx bx-log-out-circle\"></i></span></div>"; 
     }
     lista=lista+"</div>";
...
title=title+"</li>";
title=title+lista;
title=title+"<li class=\"dropdown-menu-footer\"><a class=\"dropdown-item p-50 text-primary justify-content-center\" href=\"javascript:void(0)\" onclick=\"CloseNote()\">CLOSE NOTIFICATIONS</a></li>";
title=title+"</ul></li>";
